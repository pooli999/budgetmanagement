...
switch($KeyPage)
{
	case "financepaypc":
			...
			$startupPage = "startup";
			$actionPage = "financepaypc_action";
			$listPage = "financepaypc_list";
			$addPage = "financepaypc_add";
			//$confirmPage = "typeact_confirm";
			$viewPage = "financepaypc_view";
			$sortPage = "financepaypc_sort";
