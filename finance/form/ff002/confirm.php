...
<?php } ?>  
  ...
  <tr>
   ...
   <tr>
    ...
    <td><?php echo $get->getMasterCountryName($_POST["CountryCode"]);?></td>
  </tr>  
  ...
  <tr>
    <th>การเดินทาง (ไป)</th>
  	<td>
        ...
        <div style="float:left; width:120px;"><?php echo dateFormat($_POST["StartDate1"]);?></div>
        <div style="float:left; width:115px;">ถึงประเทศจุดหมายวันที่</div>    
        <div style="float:left; width:120px;"><?php echo dateFormat($_POST["EndDate1"]);?></div>
</td>
  </tr> 
   ...
   <tr>
    ...
    <div style="float:left; width:120px;"><?php echo dateFormat($_POST["StartDate2"]);?></div>
    <div style="float:left; width:115px;">ถึงประเทศไทยวันที่</div>    
    <div style="float:left; width:120px;"><?php echo dateFormat($_POST["EndDate2"]);?></div>     
</td>
  </tr> 
