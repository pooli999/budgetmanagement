...
function ValidateForm(f){
		...
		if(getValueTextEditor('Detail') == ""){
			jAlert('กรุณากรองช่องมีความจำเป็นเร่งด่วนที่จะต้องดำเนินการ',function(){
				JQ('#Detail').focus();
			});
			return false;
		}
		if(getValueTextEditor('Purpose') == ""){
			jAlert('กรุณากรองช่องเพื่อใช้ในงาน',function(){
				JQ('#Purpose').focus();
			});
			return false;
		}
...
?> 	
  ...
  <tr>
    ...
    <tr>
    <th>พัสดุที่จะจัดซื้อ/จัดจ้าง</th>
    <td class="require">*</td>
...
<?php 
 ...
 ?>
  ...
  <tr>
    <th colspan="3">มีความจำเป็นเร่งด่วนที่จะต้องดำเนินการ <span class="require">*</span></th>
  </tr>  
  <tr>
    <td  colspan="3">
	<?php
    ...
    <tr>
    <th colspan="3">เพื่อใช้ในงาน <span class="require">*</span></th>
  </tr>  
  <tr>
    <td  colspan="3">
	<?php
	...
	?>	
      ...
      <tr>
    <th colspan="3">ระบุเหตุผลความจำเป็นเร่งด่วนเพิ่มเติม</th>
  </tr>  
  <tr>
    <td  colspan="3">
	<?php
...
<tr style="vertical-align:top;">
    <th>บริษัท/ห้าง/ร้าน</th>
    <td class="require">&nbsp;</td>
  	<td>
<input type="text" name="PartnerCode" id="PartnerCode" value="<?php echo $PartnerCode; ?>" style="width:100px;" />
<input type="text" name="PartnerName" id="PartnerName" value="<?php echo $PartnerName; ?>" style="width:300px;" />
    </td>
</tr> 
<tr>
    <th>&nbsp;</th>
...
ใบเสร็จรับเงิน/ใบกำกับภาษี/ใบส่งของ/ใบแจ้งหนี้/เล่มที่ <input type="text" name="BillNo" id="BillNo" value="<?php echo $BillNo; ?>" style="width:100px;" /> 
เลขที่ <input type="text" name="BillNumber" id="BillNumber" value="<?php echo $BillNumber; ?>" style="width:100px;" /> 
ลงวันที่ 
<?php 
...
<!--END รายการค่าใช้จ่าย-->
    ...
    <tr>
    <th colspan="3">คณะกรรมการตรวจรับพัสดุ</th>
  </tr>  
<tr style="vertical-align:top;">
