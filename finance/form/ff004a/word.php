...
ซึ่งมีผู้เข้าร่วมประชุมจำนวน <span class="textcolor"><?php echo ($AmountPerson)?$AmountPerson:'-'; ?></span> คน  โดยมีค่าใช้จ่ายดังนี้   
</td>
  </tr>
   <tr>
    <td colspan="2" height="16"></td>
...
?>
  ...
  <tr>
    <td colspan="2"  style="text-indent:40px; text-align:justify" >จึงใคร่ขออนุมัติจัดประชุมและยืมเงินทดรอง เป็นจำนวนเงิน <span class="textcolor"><?php echo number_format($TotalBorrow,2);?></span> บาท (<span class="textcolor"><?php echo JThaiBaht::_($TotalBorrow); ?></span>)
