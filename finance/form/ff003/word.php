...
ความเป็นมา (เรื่องเดิม) <span class="textcolor"><?php echo $Detail; ?></span> โดยมีค่าใช้จ่ายดังนี้   
</td>
  </tr>
   <tr>
    <td colspan="2" height="16"></td>
...
<?php } ?>        
  ...
  <tr>
    <td colspan="2"  style="text-indent:40px; text-align:justify" >
ดังนั้น <span class="textcolor"><?php echo $get->getOrgName($BgtYear, $OrganizeCode);?></span> พิจารณาเห็นควรสนับสนุนงบประมาณ จากงบประมาณของ    
 ...
 กิจกรรม&nbsp;<span class="textcolor"><?php echo $get->getPrjActName($PrjActCode); ?></span> (<span class="textcolor"><?php echo $PrjActCode; ?></span>) 
  ...
  <tr>
    <td colspan="2"  style="text-indent:40px; text-align:justify" >
จึงเรียนมาเพื่อโปรดพิจารณาอนุมัติเงินสนับสนุนดังกล่าวต่อไปด้วย จะเป็นพระคุณ
	</td>
  </tr>
</table>
