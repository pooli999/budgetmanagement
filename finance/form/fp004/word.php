...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td align="right" valign="top" style="font-size:14pt;"><?php echo $FormCodeAlias; ?> <div>(วงเงินการจัดหาไม่เกิน 5,000 บาท)</div></td>
  </tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="3" align="center">
  ...
  <tr>
    <td colspan="2"  style="text-indent:40px; text-align:justify"> ด้วย <span class="textcolor"><?php echo $get->getPItemName($BgtYear,$PItemCode); ?></span> มีความประสงค์ที่จะต้องดำเนินการ <span class="textcolor"><?php echo strip_tags($Detail); ?></span> ภายใต้ <span class="textcolor"><?php echo $get->getPItemName($BgtYear,$PItemCode); ?></span> &nbsp;<span class="textcolor"><?php echo $get->getPrjDetailName($PrjDetailId); ?></span> กิจกรรม&nbsp;<span class="textcolor"><?php echo $get->getPrjActName($PrjActCode); ?></span> (<span class="textcolor"><?php echo $PrjActCode; ?></span>) 
      ซึ่งมีวงเงินงบประมาณไม่เกิน 5,000 บาท </td>
  </tr>
  <tr>
    <td colspan="2"  style="text-indent:40px; text-align:justify"> แผนงานฯ จึงได้จัดซื้อ/จัดจ้าง <span class="textcolor"><?php echo $Title; ?></span> จากบริษัท/ห้าง/ร้าน <span class="textcolor"><?php echo $PartnerName; ?></span> ตามใบเสร็จรับเงิน/ใบกำกับภาษี/ใบส่งของ/ใบแจ้งหนี้/เล่มที่ <span class="textcolor"><?php echo $BillNo; ?></span> เลขที่ <span class="textcolor"><?php echo $BillNumber; ?></span> ลงวันที่ <span class="textcolor"><?php echo dateFormat($BillDate); ?></span> เป็นเงินทั้งสิ้น <span class="textcolor"><?php echo number_format($TotalCost,2);?></span> บาท (<span class="textcolor"><?php echo JThaiBaht::_($TotalCost);?></span>) ดังรายละเอียดในสิ่งที่ส่งมาด้วยพร้อมนี้ </td>
  </tr>
  <tr>
    <td colspan="2" height="16"></td>
  </tr>
  ...
  <tr>
    <td colspan="2"  style="text-indent:40px; text-align:justify;"> 2.1 ประกาศสำนักงานคณะกรรมการสุขภาพแห่งชาติ เรื่องหลักเกณฑ์ แนวทาง และวิธีปฏิบัติเกี่ยวกับการพัสดุ พ.ศ.2551 ข้อ 5 กำหนดว่า การจัดหาพัสดุโดยวิธีตกลงราคา 
      ในกรณีที่เป็นการจัดหาพัสดุครั้งหนึ่งซึ่งมีวงเงินไม่เกิน 5,000 บาท หรือการจัดหาพัสดุในกรณีจำเป็นและเร่งด่วนที่เกิดขึ้นโดยมิได้คาดหมายไว้ก่อน และไม่อาจดำเนินการตามปกติได้ทัน ให้เจ้าหน้าที่หรือพนักงานดำเนินการไปก่อน แล้วให้ทำบันทึกขออนุมัติจัดหาพัสดุเสนอต่อผู้มีอำนาจอนุมัติโดยทันที </td>
  </tr>
  <tr>
    <td colspan="2"  style="text-indent:40px; text-align:justify;"> 2.2 ตามระเบียบคณะกรรมการบริหารสำนักงานคณะกรรมการสุขภาพแห่งชาติว่าด้วยการรับการเก็บรักษา การจ่ายเงิน และการบัญชี พ.ศ. 2551 ข้อ 6 กำหนดให้เลขาธิการมีอำนาจอนุมัติก่อหนี้ผูกพันทั้งที่ดำเนินการตามระเบียบว่าด้วยการพัสดุ หรือกรณีการสนับสนุนหรือดำเนินโครงการของสำนักงานที่มิใช่การดำเนินงานตามระเบียบว่าด้วยการพัสดุได้ภายในวงเงินไม่เกิน 10 ล้านบาท หากเกินกว่า 10 ล้านบาทให้เป็นอำนาจของ คบ. และคำสั่งสำนักงานคณะกรรมการสุขภาพแห่งชาติที่ 24/2551 เรื่อง มอบอำนาจให้ปฏิบัติหน้าที่แทน ได้มอบอำนาจให้รองเลขาธิการฯ (นพ.อุกฤษฏ์  มิลินทางกูร) จัดหาพัสดุ ก่อหนี้ผูกพัน อนุมัติโครงการ จ่ายเงิน ตามระเบียบ ประกาศ และคำสั่งที่เกี่ยวข้องของ คสช. คบ. และสำนักงาน ในวงเงินครั้งละไม่เกิน 2 ล้านบาท (ยกเว้นภายใต้แผนงานพัฒนาระบบสนับสนุน) </td>
  </tr>
  <tr>
    <td colspan="2"  style="text-indent:40px; text-align:justify;"> 2.3 ประกาศสำนักงานคณะกรรมการสุขภาพแห่งชาติ เรื่องหลักเกณฑ์ แนวทาง และวิธีปฏิบัติเกี่ยวกับการพัสดุ พ.ศ. 2551 ข้อ 16 กำหนดว่า สำหรับการตรวจรับพัสดุซึ่งมีวงเงินไม่เกิน 50,000 บาท (ห้าหมื่นบาท) ให้ดำเนินการโดยพนักงาน 1 คน สำหรับการตรวจรับพัสดุซึ่งมีวงเงินเกิน 50,000 บาท (ห้าหมื่นบาท) ให้ดำเนินการโดยคณะกรรมการตรวจรับพัสดุจำนวน 3 คน บุคคลซึ่งทำหน้าที่ตรวจรับพัสดุจะต้องไม่เป็นเจ้าหน้าที่พัสดุหรือคณะกรรมการจัดหาพัสดุ </td>
  </tr>
  <tr>
    <td colspan="2" height="16"></td>
  </tr>
  ...
  <tr>
    <td colspan="2"  style="text-indent:40px; text-align:justify"> จึงเรียนมาเพื่อโปรดพิจารณา </td>
  </tr>
  <tr>
    <td colspan="2"  style="text-indent:40px; text-align:justify"> 3.1 อนุมัติให้จัดซื้อ/จัดจ้าง <span class="textcolor"><?php echo $Topic; ?></span> จากบริษัท/ห้าง/ร้าน <span class="textcolor"><?php echo $PartnerName; ?></span> ดังรายละเอียดในข้อ 1 โดยวิธีตกลงราคา กรณีจำเป็นและเร่งด่วน </td>
  </tr>
  <tr>
    <td colspan="2"  style="text-indent:40px; text-align:justify"> 3.2 อนุมัติให้เบิกจ่ายเงินจำนวนทั้งสิ้น <span class="textcolor"><?php echo number_format($TotalCost,2);?></span> บาท (<span class="textcolor"><?php echo JThaiBaht::_($TotalCost);?></span>) โดยเบิกจ่ายจาก <span class="textcolor"><?php echo $get->getSourceExName($SourceExId); ?></span> &nbsp;<span class="textcolor"><?php echo $get->getPItemName($BgtYear,$PItemCode); ?></span> &nbsp;<span class="textcolor"><?php echo $get->getPrjDetailName($PrjDetailId); ?></span> กิจกรรม&nbsp;<span class="textcolor"><?php echo $get->getPrjActName($PrjActCode); ?></span> (<span class="textcolor"><?php echo $PrjActCode; ?></span>) </td>
  </tr>
</table>
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" >
  <tr>
