...
<!-- <tr>
    <th style="width:30;">จ่ายเป็น</th>
    <td colspan="4">
<input type="radio" name="ClearType" id = "cash1" value="cash" <?php// if(!$ClearType || ($ClearType=="cash")){ ?> checked="checked" <?php //} ?> />
เงินสด
<input type="radio" id = "transfer1" name="ClearType" value="transfer" <?php// if($ClearType=="transfer"){ ?> checked="checked" <?php// } ?> />
เงินโอน<br />
<div style="float:left"><b>จำนวน</b> <input type="text" name="ReturnCost" id="ReturnCost" value="1000" style="width:100px; text-align:center;" onkeypress="return validChars(event,2)"  /> <b>บาท</b> </div><div id = "hide_p"><input type="checkbox" name="checkbox2" value="checkbox"  />
  เงินสดย่อย (คงเหลือ 900 บาท)</div></td>
    </tr> -->
...
<script language="javascript" type="text/javascript">
function Save(f){
	// if (JQ("#ReturnCost").val() >900){
	// 	alert("จำนวนเงินสดย่อยคงเหลือไม่พอ")
	// }
