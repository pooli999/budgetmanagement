...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td align="right" valign="top" style="font-size:14pt;"><?php echo $FormCodeAlias; ?> <div>(วงเงินการจัดหาเกิน 300,000 บาท)</div></td>
  </tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="3" align="center">
  ...
  <tr>
    <td colspan="2" style="border-bottom:1px solid #999; padding-bottom:10px;"><div style="width:50px; float:left;">เรื่อง</div>
      <span class="textcolor"><?php echo $Topic; ?></span></td>
  </tr>
  <tr>
    <td colspan="2" style="padding-top:10px;"><div style="width:50px; float:left;">เรียน</div>
  ...
  <tr>
    <td colspan="2"  style="text-indent:40px; text-align:justify"> ด้วย <span class="textcolor"><?php echo ($PItemCode)?($get->getPItemName($BgtYear,$PItemCode)):'<span style="color:#999;">-ไม่ระบุ-</span>'; ?></span> มีความประสงค์จะดำเนินการ <span class="textcolor"><?php echo $Detail; ?></span> ภายใต้กิจกรรม <span class="textcolor"><?php echo ($PrjActCode)?($get->getPrjActName($PrjActCode)):'<span style="color:#999;">-ไม่ระบุ-</span>'; ?></span> <span class="textcolor"><?php echo ($PrjDetailId)?($get->getPrjDetailName($PrjDetailId)):'<span style="color:#999;">-ไม่ระบุ-</span>'; ?></span> และในประกาศสำนักงานคณะกรรมการสุขภาพแห่งชาติ เรื่องหลักเกณฑ์ แนวทาง และวิธีปฏิบัติเกี่ยวกับการพัสดุ พ.ศ. 2551 ข้อ 4 กำหนดว่า การจัดหาพัสดุลักษณะพิเศษ ให้แผนงานต่างๆ ที่มีความประสงค์จะจัดหาพัสดุ จัดทำบันทึกคำขออนุมัติหลักการจัดหาพัสดุเสนอต่อผู้มีอำนาจอนุมัติ ซึ่งจะต้องแสดงรายการประกอบการพิจารณานั้น </td>
  </tr>
  <tr>
    <td colspan="2" height="16"></td>
  </tr>
  <tr>
    <td colspan="2"  style="padding-left:40px; text-align:justify"> ในการนี้ แผนงานฯ จึงใคร่ขออนุมัติจัดซื้อ/จัดจ้าง โดยมีรายละเอียดของการจัดหาพัสดุดังต่อไปนี้
      <div>1. วัตถุประสงค์หรือความจำเป็นในการจัดหาพัสดุ</div>
      <div style="text-indent:30px;">- <span class="textcolor">
        <?php  echo ($Purpose)?(strip_tags($Purpose)):'<span style="color:#999;">-ไม่ระบุ-</span>'; ?>
      </span></div>
...
?>
          <tr style="vertical-align:top;">
            <td><?php echo ($m+1); ?>) <span class="textcolor"><?php echo $get->getCostItemName($CostItemCode);?></span>
              <?php
...
?>
      ...
      <div style="text-indent:40px;"> ภายในวงเงินงบประมาณทั้งสิ้น <span class="textcolor"><?php echo number_format($TotalCost,2);?></span> บาท (<span class="textcolor"><?php echo JThaiBaht::_($TotalCost);?></span>) รวมหักภาษีมูลค่าเพิ่ม จากงบประมาณ <span class="textcolor"><?php echo $get->getSourceExName($SourceExId); ?></span> &nbsp;<span class="textcolor"><?php echo $get->getPItemName($BgtYear,$PItemCode); ?></span> &nbsp;<span class="textcolor"><?php echo $get->getPrjDetailName($PrjDetailId); ?></span> กิจกรรม&nbsp;<span class="textcolor"><?php echo $get->getPrjActName($PrjActCode); ?></span> (<span class="textcolor"><?php echo $PrjActCode; ?></span>) </div>
      <div>6. แต่งตั้งคณะกรรมการจัดหาพัสดุ</div>
      <div>
        <div style="text-indent:40px;"> ตามที่ประกาศสำนักงานคณะกรรมการสุขภาพแห่งชาติ เรื่องหลักเกณฑ์ แนวทาง และวิธีปฏิบัติเกี่ยวกับการพัสดุ พ.ศ. 2551 ในข้อ 6-8 หากเป็นการจัดหาพัสดุครั้งหนึ่งซึ่งมีวงเงินเกิน 300,000 บาท (สามแสนบาทถ้วน) จะต้องแต่งตั้งคณะกรรมการจัดหาพัสดุจำนวน 3 คน ซึ่งกองแผนงานฯ เสนอขอแต่งตั้ง </div>
        <!--///////////////////////////////////////////////-->
        <table  width="690" border="0" cellspacing="1" cellpadding="0" class="tbl-list-sub">
          <tr>
            <td style="text-align:left; width:40px;">&nbsp;</td>
            <td style="text-align:left; width:250px;">1) <?php echo $get->fn_getFullNameByPersonalCode($CommiteeName1);?></td>
            <td style="text-align:left; width:200px;">ตำแหน่ง <?php echo $get->getPositionName($CommiteePosition1);?></td>
            <td style="text-align:left; width:200px;"><?php echo $get->getDutyName($CommiteeDuty1); ?></td>
          </tr>
          <tr>
            <td style="text-align:left;">&nbsp;</td>
            <td style="text-align:left;">2) <?php echo $get->fn_getFullNameByPersonalCode($CommiteeName2);?></td>
            <td style="text-align:left;">ตำแหน่ง <?php echo $get->getPositionName($CommiteePosition2);?></td>
            <td style="text-align:left;"><?php echo $get->getDutyName($CommiteeDuty2); ?></td>
          </tr>
          <tr>
            <td style="text-align:left;">&nbsp;</td>
            <td style="text-align:left;">3) <?php echo $get->fn_getFullNameByPersonalCode($CommiteeName3);?></td>
            <td style="text-align:left;">ตำแหน่ง <?php echo $get->getPositionName($CommiteePosition3);?></td>
  ...
  <tr>
    <td colspan="2"  style="text-indent:40px; text-align:justify" > จึงเรียนมาเพื่อโปรดพิจารณาอนุมัติหลักการให้จัดหาพัสดุดังรายละเอียดข้างต้น และมอบหมายให้งานพัสดุ ดำเนินการตามระเบียบต่อไปด้วย จะเป็นพระคุณ </td>
  </tr>
</table>
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" >
  <tr>
