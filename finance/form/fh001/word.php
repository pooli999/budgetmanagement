...
<table  width="100%" border="0" cellspacing="1" cellpadding="0"> 
  ...
  <tr>
    <td colspan="2"  style="text-indent:40px; text-align:justify"><span class="textcolor"><?php echo $Detail; ?></span></td>
  </tr>
...
ในการนี้ จึงใคร่ขออนุมัติหลักการจ้างบุคคลเพื่อทำหน้าที่ <?php echo ($Duty)?($get->getPositionName($Duty)):'<span style="color:#999;">-ไม่ระบุ-</span>'; ?>
 โดยมีรายละเอียด ดังต่อไปนี้    

<div>1. วัตถุประสงค์หรือความจำเป็นในการจัดจ้าง</div>
...
<div>2. รายละเอียดเกี่ยวกับการจ้าง</div>
...
<div>3. กำหนดเวลาที่ต้องการจ้าง</div>
<div style="padding-left:30px;">- สัญญาจ้าง <span class="textcolor"><?php echo $AmountMonth; ?></span> เดือน <span class="textcolor"><?php echo ($AmountDate)?$AmountDate:"-"; ?></span> วัน ตั้งแต่วันที่ <span class="textcolor"><?php echo dateFormat($StartDate1);?></span> ถึงวันที่ <span class="textcolor"><?php echo dateFormat($EndDate1);?></span> </div>    
...
ภายในวงเงินงบประมาณ <span class="textcolor"><?php echo number_format($TotalCost,2);?></span> บาท (<span class="textcolor"><?php echo JThaiBaht::_($TotalCost);?></span>) รวมหักภาษี ณ ที่จ่าย จากงบประมาณ
<span class="textcolor"><?php echo $get->getSourceExName($SourceExId); ?></span>
 ...
 กิจกรรม&nbsp;<span class="textcolor"><?php echo $get->getPrjActName($PrjActCode); ?></span> (<span class="textcolor"><?php echo $PrjActCode; ?></span>) 
  ...
  <tr>
    <td colspan="2"  style="text-indent:40px; text-align:justify" >
จึงเรียนมาเพื่อโปรดพิจารณาอนุมัติหลักการจัดจ้างดังรายละเอียดข้างต้น และมอบหมายให้งานทรัพยากรบุคคลดำเนินการตามระเบียบต่อไปด้วย จะเป็นพระคุณ
	</td>
  </tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" >
  <tr>
    ...
    <td style="vertical-align:top; width:50%;"><table  border="0" cellspacing="0" cellpadding="0"  align="center">
      ...
      <tr>
        <td align="left">&nbsp;</td>
        <td style="text-align:center;"><?php echo ($RQOrganizeCode)?($get->getOrganizeName($RQOrganizeCode)):'<span style="color:#999;">-ไม่ระบุ-</span>'; ?></td>
        <td align="right">&nbsp;</td>
      </tr>
    </table></td>
  </tr>
