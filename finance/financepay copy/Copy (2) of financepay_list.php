...
function create_tblCodeId(){ // สร้างตาราง แสดงรายการ สชน ที่เลือก
		...
		str_tbl = '<table width="100%" border="0" class="tbl-list tablesorter"cellspacing="0">';
			...
			str_tbl = str_tbl+'<tr>';
				...
				str_tbl = str_tbl+'<th  align="center" style="width:80px;">รหัสเอกสาร</th>';
				str_tbl = str_tbl+'<th  align="center"style="width:120px;" >วันที่เอกสาร</th>';
				str_tbl = str_tbl+'<th  align="center" style="width:80px;">เลขที่ สช.น</th>';
			...
			if (JQ("#PaymentId").val() == ""){ //เพิ่ม+
				JQ('[name=CboCodeId]:checked').each(function() {	// วนสร้าง ตามจำนวนที่เลือก
							...
							str_tbl = str_tbl+'<td valign="top" class="center"><input name="DocCode'+DocCode+'" type="hidden" id="DocCode'+DocCode+'" value = "'+JQ('#tr'+JQ(this).val()+' td').eq(3).text()+'"/>'+JQ('#tr'+JQ(this).val()+' td').eq(0).text()+'</td>';
...
%</td>
         ...
         <tr>
           ...
           <td colspan="4" style="text-align:left"><input name="CashValue" id = "CashValue" type="text" />
บาท</td>
          </tr>
         <tr>
           <th colspan="6">เงินโอน/เช็ค &nbsp;&nbsp;&nbsp;</th>
          </tr>
         <tr>
           <td colspan="6">
		   <input id="btn_bank" name="search232" type="button" value="เพิ่มข้อมูล เงินโอน/เช็ค" class="btnActive" />
		   <div id = "div_bookbank"></div><!--ตารางวิธีการจ่ายเงิน--></td>
         </tr>
       </table>
	    </fieldset>
	   </td>
