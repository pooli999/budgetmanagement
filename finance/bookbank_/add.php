...
<fieldset  >
<legend ><b>บัญชีธนาคาร</b></legend>
  <table width="100%" border="0" cellspacing="2" cellpadding="2">
    <tr>
      <td width="13%" bgcolor="E6E6E6">ชื่อธนาคาร</td>
      <td width="87%"><select name="select4">
    ...
    <tr>
      <td bgcolor="E6E6E6">สาขา</td>
      <td><input type="text" name="textfield2" /></td>
    </tr>
    <tr>
      <td bgcolor="E6E6E6">ประเภท</td>
    ...
    <tr>
      <td bgcolor="E6E6E6">เลขที่บัญชีธนาคาร</td>
