...
<thead>
  <tr>
    ...
    <th align="center" style="width:350px;">เพดานเงินสดย่อย (บาท)</th>
    <th align="center" style="width:350px;">จุดแจ้งเตือน (บาท)</th>
    <th align="center">วันทีทำรายการ</th>
    </tr>
</thead>
<tbody>
<?php
...
?>
  <tr>
	...
	echo number_format($r->MaxPettyCash,2);
	?></td>
    <td valign="top" class="center"><?
	echo number_format($r->AlertPettyCash,2);
	?></td>
