...
<tr>
  <th>บัญชีออมทรัพทย์เลขที่</th>
  <td class="require">&nbsp;</td>
  <td><?=$BookbankNumber;?></td>
</tr>
<tr>
  <th>ชื่อธนาคาร</th>
  <td class="require">&nbsp;</td>
...
<tr>
<th><span style="width:200px;">ผูกบัญชีกระแสรายวัน</span></th>
<td class="require">*</td>
<td><?php 
  		$tag_attribs = $BankId;
		$tag_attribs1 = $CurrentAccountId;
		echo $get->getBankNameSelect("CurrentAccountId",$tag_attribs,$tag_attribs1,$CurrentAccountId,"เลือก");//$tag_name,$tag_attribs,$selected,$lebel
	?></td>
</tr>
 <tr>
    <th>&nbsp;</th>
