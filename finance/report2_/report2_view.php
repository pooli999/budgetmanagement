...
function icoView($r, $text)
{
	...
	vprintf('<a href="%s" class="%s" title="%s"><span>%s</span></a>',array(
		"javascript:self.location='?mod=".LURL::dotPage($viewItemPage)."&id=".$_REQUEST["id"]."&itemid=".$r->ID."'",                                                      
		'ico view',
		$label,
		$label
	));
...
function icoEdit($a,$r)
{
	global $editItemPage;
	$label = 'แก้ไข';
	vprintf('<a href="%s" class="%s" title="%s"><span>%s</span></a>',array(
		"javascript:self.location='?mod=".LURL::dotPage($editItemPage)."&id=".$_REQUEST["id"]."&itemid=".$r->ID."'",
		'ico edit',
		$label,
		$label
	));
...
<div class="sysinfo">
  ...
  <div class="sysdetail"><?php echo 'ข้อมูลครุภัณฑ์ '.$AssetName;?></div>
</div>

<table width="100%" border="0" cellspacing="1" cellpadding="1" class="boxfilter">
  <tr>
    <td>รายงานการยืม-คืนครุภัณฑ์</td>
    <td align="right"></td>
  </tr>

  <tr>
    <td>รายงานการโอนย้ายครุภัณฑ์</td>
    <td align="right"></td>
  </tr>
  <tr>
    <td>รายงานการจำหน่ายครุภัณฑ์</td>
    <td align="right"></td>
  </tr>
  <tr>
    <td>รายงานค่าเสื่อมครุภัณฑ์ที่มีราคาตั้งแต่ 5,000 บาท(รายตัว)</td>
    <td align="right"></td>
  </tr>
  <tr>
    <td>รายงานค่าเสื่อมครุภัณฑ์ที่มีราคาตั้งแต่ 5,000 บาท</td>
    <td align="right"></td>
  </tr>
  <tr>
    <td>รายงานรายการครุภัณฑ์</td>
    <td align="right"></td>
  </tr>

</table>
<div class="cms-box-navpage"><?php echo NavPage(array('total'=>$dataitem['total']));?></div>
