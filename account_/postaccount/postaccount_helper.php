...
class sHelper
{
	...
	*/	
	function getDataList(&$list,$limit=20){
		...
		$sql="select tblfinance_payment.*,$fn1,$fn2,$fn3,$fn4,$fn5,$fn6,$fn7 from tblfinance_payment inner join tblfinance_payment_comp on tblfinance_payment.PaymentId = tblfinance_payment_comp.PaymentId  ".$where_r."  order by tblfinance_payment.PaymentId DESC";
		//echo $sql;
