...
/* <![CDATA[ */
	...
	function Search(){
		...
		window.location.href="?mod=<?php echo LURL::dotPage($listPage)?>&pvsearch="+ pvsearch+"&docsearch="+docsearch+"&tsearch="+tsearch+"&descsearch="+descsearch;
	}
...
<div id="boxSearch" class="boxsearch" style="display:none;">
  <table  border="0" align="center" cellpadding="2" cellspacing="5" >
     ...
     <tr>
      <td  align="right"><strong>เลขที่ สช.น : </strong></td>
        <td align="left">
        <input name="docsearch" id="docsearch" type="text" class="input-search" size="30" value="<?php echo $_REQUEST['docsearch']?>" />
        </td>
    </tr>
    <tr>
      <td  align="right"><strong>จ่ายให้ : </strong></td>
        <td align="left">
...
<span style="color:#FF6600; font-weight:bold;">
    ...
    <?php if($_REQUEST['docsearch']){?> &quot;เลขที่ สช.น : <?php echo $_REQUEST['docsearch'];?>&quot;<?php }?>
    <?php if($_REQUEST['tsearch']){?>&quot;จ่ายให้ : <?php echo $_REQUEST['tsearch'];?>&quot;<?php }?>
