...
class sHelper
{
	...
	*/
	...
	function getDataList(&$list,$limit=20){
		...
		$sql="select tblfinance_payment.*,$fn1,$fn2,$fn3,$fn4,$fn5,PType,PartnerCode from tblfinance_payment inner join tblfinance_payment_comp on tblfinance_payment.PaymentId = tblfinance_payment_comp.PaymentId  ".$where_r;
