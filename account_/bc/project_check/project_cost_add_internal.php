...
?>
 ...
 <tr>
    <th style="width:200px; text-align:left">กิจกรรมหลัก</th>
    <td style="width:948px; text-align:left; font-weight:bold"><?php echo $get->getPItemCode($PItemCode);?></td>
  </tr>
 <tr>
...
?>
 ...
 <tr>
   <th style="width:200px; text-align:left">งบประมาณที่ได้รับกลั่นกรอง</th>
   <td style="width:948px; text-align:left; font-weight:bold">
   <?php $TotalAllot = $get->getBGTotalInternal($_REQUEST["BgtYear"],$_REQUEST["OrganizeCode"],$allot[0]->AllotId,0,0,$_REQUEST["ScreenLevel"],$_REQUEST["SCTypeId"]);?>
   <?php echo ($TotalAllot > 0)?number_format($TotalAllot,2):"0.00"; ?> บาท</td>
 </tr>
  <tr>
   <th style="width:200px; text-align:left">งบประมาณกลั่นกรองคงเหลือ</th>
   <td style="width:948px; text-align:left; font-weight:bold"><?php echo ($SumTotalCost > 0)?number_format($SumTotalCost,2):"0.00"; ?> บาท</td>
 </tr>
  <tr>
   <th style="width:200px; text-align:left">รวมงบประมาณชี้แจง</th>
   <td style="width:948px; text-align:left; font-weight:bold">
   <span id="total"><?php echo number_format($get->getTotalPrjInternalX4($BgtYear,0,0,$PrjId,$PrjDetailId,$PrjActId,0,0,$_REQUEST["CostItemCode"]),2); ?></span> บาท
...
<tr>
    ...
    <div id="MoreFile2">
   <?php
$DItem = $get->getItemRequireInternal($CostItemCode,$PrjActId);
...
<input type="hidden" name="CostIntId" id="CostIntId" value="<?php echo $CostIntId;?>">
...
/*function CalSum(){
	...
	var SumCost = (Value1*1)*(Value2*1)*(Value3*1)*(Value4*1);
	var total = SumCost.Money(2);
	$('SumCostText').set('html',JThaiBaht(total));
}
*/
function CalSum(){
	var sumTotal=0;
