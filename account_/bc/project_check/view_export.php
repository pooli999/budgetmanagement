...
<table width="100%" border="1" cellspacing="1" cellpadding="0" class="tbl-history-check">
<thead>
  <tr>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0" class="tbl-view" style="margin-bottom:0px;">
  ...
  <tr>
    <td colspan="2"><table width="100%" border="1" cellspacing="1" cellpadding="0" class="tbl-history-check">
        <thead>
          <tr>
