...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl-cost" >
  ...
  foreach($BGCate as $BGCateRow){ 
	...
	$SumTotalCost = $get->getTotalPrjInternalX4(0,0,0,0,0,$_REQUEST["PrjActId"],0,0,0,0,$CostTypeId);
  ?>
  <tr class="cate">
  ...
  foreach($BGLevel1 as $BGLevel1Row){ 
  	foreach($BGLevel1Row as $c=>$d){
		${$c} = $d;
			...
			$SumTotalCost = $get->getTotalPrjInternalX4(0,0,0,0,0,$_REQUEST["PrjActId"],0,0,$CostItemCode,$ParentCode,0,$LevelId,$HasChild);

  ?>
  <tr class="level1">
    <td style="text-indent:10px;">
    <?php if($HasChild == N){ ?><a href="?mod=<?php echo LURL::dotPage($AddCostInternal); ?>&CostItemId=<?php echo $CostItemId; ?>&PrjActId=<?php echo $PrjActId; ?>&PrjDetailId=<?php echo $PrjDetailId; ?>&CostItemCode=<?php echo $CostItemCode; ?>&ParentCode=<?php echo $ParentCode; ?>&SCTypeId=<?php echo $_REQUEST['SCTypeId']; ?>&ScreenLevel=<?php echo $_REQUEST['ScreenLevel']; ?>&OrganizeCode=<?php echo $_REQUEST['OrganizeCode']; ?>&BgtYear=<?php echo $_REQUEST['BgtYear']; ?>">
    ...
    <td style="text-align:right;"><?php echo ($SumTotalCost > 0)?number_format($SumTotalCost,2):"-"; ?></td>
			...
			$CRI=0;
			$CR=0;
			$CRequireItem = $get->getItemRequireInternal($CostItemCode,$_REQUEST["PrjActId"]);
  ...
  foreach($BGLevel2 as $BGLevel2Row){ 
  	foreach($BGLevel2Row as $e=>$f){
		...
		$CSItem = $get->getListCostItem($CostItemCode,$ParentCode);
		$SumTotalCost = $get->getTotalPrjInternalX4(0,0,0,0,0,$_REQUEST["PrjActId"],0,0,$CostItemCode,0,0,$LevelId,$HasChild);
  ?>
  <tr class="level2">
    <td style="text-indent:20px;"><?php if($HasChild == N){ ?><a href="?mod=<?php echo LURL::dotPage($AddCostInternal); ?>&CostItemId=<?php echo $CostItemId; ?>&PrjActId=<?php echo $PrjActId; ?>&PrjDetailId=<?php echo $PrjDetailId; ?>&CostItemCode=<?php echo $CostItemCode; ?>&ParentCode=<?php echo $ParentCode; ?>&SCTypeId=<?php echo $_REQUEST['SCTypeId']; ?>&ScreenLevel=<?php echo $_REQUEST['ScreenLevel']; ?>&OrganizeCode=<?php echo $_REQUEST['OrganizeCode']; ?>&BgtYear=<?php echo $_REQUEST['BgtYear']; ?>">
  ...
  <tr class="total">
    <td colspan="9" style="text-align:right;">(<?php echo JThaiBaht::_($get->getTotalPrjInternalX4($BgtYear,0,0,$PrjId,$PrjDetailId,$PrjActId,0,0)); ?>) รวมงบประมาณทั้งสิ้น</td>
    <td style="text-align:right; font-weight:bold"><?php echo ($get->getTotalPrjInternalX4($BgtYear,0,0,$PrjId,$PrjDetailId,$PrjActId,0,0))?number_format($get->getTotalPrjInternalX4($BgtYear,0,0,$PrjId,$PrjDetailId,$PrjActId,0,0),2):'-'; ?></td>
  </tr>
</table>
