...
function printDocument(){
	window.location.href="?mod=<?php echo LURL::dotPage('report9_print')?>&format=raw<?php echo $get->getQueryString(); ?>";
}

function saveToExcel(){
	window.location.href="?mod=<?php echo LURL::dotPage('report9_excel')?>&format=raw<?php echo $get->getQueryString(); ?>";
}
...
function loadPlan(BgtYear){
	...
	JQ.ajax({
		  type: "POST",
		  url: "?mod=<?php echo LURL::dotPage('report9_action');?>",		   
...
<input type="hidden" name="mod" id="mod" value="<?php echo LURL::dotPage('report9_list');?>" />
