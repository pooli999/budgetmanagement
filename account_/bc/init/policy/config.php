...
{
	case "policy":
			$PathUpload = VSROOT.'upload/policy/';
			$startupPage = "startup";
			$actionPage = "policy_action";
			$listPage = "policy_list";
			$addPage = "policy_add";
			//$confirmPage = "policy_confirm";
			$viewPage = "policy_view";
			$sortPage = "policy_sort";
			$indicatorListPage = "policy_ind";
			$indicatorAddPage = "policy_ind_add";
...
$GLOBALS["indicatorListPage"] = $indicatorListPage;
$GLOBALS["indicatorAddPage"] = $indicatorAddPage;
