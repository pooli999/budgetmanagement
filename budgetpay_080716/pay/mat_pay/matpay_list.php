...
?> 
  <tr>
    ...
    <td style="text-align:center; vertical-align:text-top"><?php echo $DocCodePay;?></td>
    <td style="text-align:left; vertical-align:text-top"><?php echo icoView($r);?></td>
    <td style="text-align:right; vertical-align:text-top"><?php echo number_format($get->getSumBudget($DocCodePay,0,0,0),2); ?></td>
