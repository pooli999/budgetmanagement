...
{
	case "otpay":
			$PathUpload = VSROOT.'upload/pay/';
			$startupPage = "startup";
			$actionPage = "otpay_action";
			$mainPage = "otpay_main";
			$listPage = "otpay_list";
			$addPage = "otpay_add";
			$confirmPage = "otpay_confirm";
			$viewPage = "otpay_view";
			...
			$appPage = "otpay_approve";
			$appconfirmPage = "otpay_appconfirm";
			
			$cancelPage = "otpay_cancel";
			$cancelconfirmPage = "otpay_cancelconfirm";
	break;
