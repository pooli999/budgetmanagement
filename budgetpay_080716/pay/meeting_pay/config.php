...
switch($KeyPage)
{
	case "mpay":
			...
			$startupPage = "startup";
			$actionPage = "mpay_action";
			$mainPage = "mpay_main";
			$listPage = "mpay_list";
			$addPage = "mpay_add";
			$confirmPage = "mpay_confirm";
			$viewPage = "mpay_view";
			...
			$appPage = "mpay_approve";
			$appconfirmPage = "mpay_appconfirm";		
			
			$cancelPage = "mpay_cancel";
			$cancelconfirmPage = "mpay_cancelconfirm";
	break;
