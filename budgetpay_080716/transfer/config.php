...
{
	case "transfer":
			$PathUpload = VSROOT.'upload/transfer/';
			$startupPage = "startup";
			$actionPage = "transfer_action";
			$mainPage = "transfer_main";
			$listPage = "transfer_list";
			$addPage = "transfer_add";
			$confirmPage = "transfer_confirm";
			$viewPage = "transfer_view";
			$printPage = "transfer_print";
			$wordPage = "transfer_word";
			...
			$appPage = "transfer_approve";
			$appconfirmPage = "transfer_appconfirm";
			$cancelPage = "transfer_cancel";
			$cancelconfirmPage = "transfer_cancelconfirm";
	break;
