...
{
	case "meeting":
			$PathUpload = VSROOT.'upload/meeting/';
			$startupPage = "startup";
			$actionPage = "meeting_action";
			$mainPage = "meeting_main";
			$listPage = "meeting_list";
			$addPage = "meeting_add";
			$addPayPage = "meeting_pay";
			$confirmPage = "meeting_confirm";
			$confirmpayPage = "meeting_confirmpay";
			$viewPage = "meeting_view";
			...
			$appPage = "meeting_approve";
			$appconfirmPage = "meeting_appconfirm";		
	break;
