...
/* <![CDATA[ */
	...
	function loadSCT(BgtYear){
			...
			JQ.ajax({
			   type: "POST",
			   url: "?mod=<?php echo LURL::dotPage('mat_action');?>",		   
...
function Search(){
	...
	window.location.href="?mod=<?php echo LURL::dotPage($listPage)?>&StartDate="+StartDate+"&EndDate="+EndDate+"&BgtYear="+BgtYear+"&PItemCode="+PItemCode+"&PrjId="+PrjId+"&PrjActCode="+PrjActCode+"&DocCode="+DocCode+"&Budget="+Budget+"&DocOperator="+DocOperator;
}
