...
$this->DOC->setPathWays(array(
	...
	array(
		'text' => 'แบบฟอร์มขออนุมัติหลักการเข้ารับการอบรม/สัมมนา/ดูงาน/ปฏิบัติงานวิจัย/เดินทางไปต่างประเทศ',
	)
));
...
/* <![CDATA[ */
	...
	function loadSCT(BgtYear){
			...
			JQ.ajax({
			   type: "POST",
			   url: "?mod=<?php echo LURL::dotPage('training_action');?>",		   
...
function Search(){
	...
	function ExportToWord(DocId){
		window.location = '?mod=front.eform.pagecenter.pagecenter_word_training&format=raw&id='+DocId;	
	}
