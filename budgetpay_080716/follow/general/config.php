...
{
	case "general":
			$PathUpload = VSROOT.'upload/general/';
			$startupPage = "startup";
			$actionPage = "general_action";
			$mainPage = "general_main";
			$listPage = "general_list";
			$addPage = "general_add";
			$confirmPage = "general_confirm";
			$confirmpayPage = "general_confirmpay";
			$viewPage = "general_view";
			$printPage = "general_print";
			$wordPage = "general_word";
			$addPayPage = "general_pay";
			...
			$appPage = "general_approve";
			$appconfirmPage = "general_appconfirm";				
	break;
