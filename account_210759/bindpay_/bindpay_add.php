...
function loadAC(){
	...
	JQ.ajax({
		  ...
		  data: "action=loadac&AcGroupId="+AcGroupId,
...
<td class="require">*</td>
<td><input name="CostName" type="text" id="CostName" value="<?php echo $CostName;?>" size="65" readonly="" /></td>
</tr>
<tr>
<th>หมวดบัญชี</th>
<td class="require">*</td>
...
<tr>
<th>&nbsp;&nbsp;&nbsp;&nbsp;ผูกบัญชีย่อย Dr. </th>
<td class="require">*</td>
<td><div id="acNumber"><?php 
  		$tag_attribs = '';
		echo $get->getAcCode("DR_AcId",$tag_attribs,$DR_AcId,"เลือก");//$tag_name,$tag_attribs,$selected,$lebel
	?></div></td>
</tr>
 <tr>
    <th>&nbsp;</th>
