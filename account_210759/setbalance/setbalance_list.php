...
<thead>
  <tr>
    <th class="no" style="width:130px">รหัสบัญชี</th>
    <th align="left" >ชื่อบัญชี</th>
    <th align="center" style="width:120px;">เดบิต(Dr.)</th>
    <th align="center" style="width:120px;">เครดิต(Cr.)</th>
    <th style="text-align:center;">ปฏิบัติการ</th>
    </tr>
</thead>
<tbody>
<?php
...
?>
  <tr>
    <td valign="top" class="left" style="padding-left:20px;" ><?php echo $AcChartCode ;?></td>
    <td valign="top" ><?php // echo icoView($r);?><?php echo $ThaiName;?></td>
    <td align="center" valign="top" ><?php echo $Dr;?></td>
    <td align="center" valign="top" ><?php echo $Cr;?></td>
    <td align="center" style="width:120px;" nowrap="nowrap" valign="top"  ><?php echo icoEdit($r);?></td>
    </tr>
