...
function ValidateForm(f){
		...
		if(JQ('#TypeActName').val() == '' || JQ('#TypeActName').val() == ' '){
			jAlert('กรุณาระบุชื่อประเภทกิจกรรม','ระบบตรวจสอบข้อมูล',function(){
				JQ('#TypeActName').focus();
			});
			return false;
		}
...
<input name="TypeActId" type="hidden"  id="TypeActId" value="<?php echo $_REQUEST['id'];?>" />
...
<td class="require">*</td>
<td><input name="TypeActName" type="text" id="TypeActName" value="<?php echo $TypeActName;?>" size="45" /></td>
</tr>
 <tr>
    <th>&nbsp;</th>
    <td>&nbsp;</td>
