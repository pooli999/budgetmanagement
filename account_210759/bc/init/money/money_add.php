...
function ValidateForm(f){
		...
		if(JQ('#CostTypeName').val() == '' || JQ('#CostTypeName').val() == ' '){
			jAlert('กรุณาระบุชื่อหมวดเงิน','ระบบตรวจสอบข้อมูล',function(){
				JQ('#CostTypeName').focus();
			});
			return false;
		}
...
<input name="CostTypeId" type="hidden"  id="CostTypeId" value="<?php echo $_REQUEST['id'];?>" />
...
<th>ชื่อหมวดเงิน</th>
<td class="require">*</td>
<td><input name="CostTypeName" type="text" id="CostTypeName" value="<?php echo $CostTypeName;?>" size="45" /></td>
</tr>
 <tr>
    <th>&nbsp;</th>
    <td>&nbsp;</td>
