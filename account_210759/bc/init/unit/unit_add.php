...
function ValidateForm(f){
		...
		if(JQ('#UnitName').val() == '' || JQ('#UnitName').val() == ' '){
			jAlert('กรุณาระบุชื่อหน่วยนับ','ระบบตรวจสอบข้อมูล',function(){
				JQ('#UnitName').focus();
			});
			return false;
		}
...
<input name="UnitID" type="hidden"  id="UnitID" value="<?php echo $_REQUEST['id'];?>" />
...
<th>ชื่อหน่วยนับ</th>
<td class="require">*</td>
<td><input name="UnitName" type="text" id="UnitName" value="<?php echo $UnitName;?>" size="45" /></td>
</tr>
<tr>
