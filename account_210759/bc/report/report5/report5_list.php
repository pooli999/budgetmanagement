...
function printDocument(){
	window.location.href="?mod=<?php echo LURL::dotPage('report5_print')?>&format=raw<?php echo $get->getQueryString(); ?>";
}

function saveToExcel(){
	window.location.href="?mod=<?php echo LURL::dotPage('report5_excel')?>&format=raw<?php echo $get->getQueryString(); ?>";
}
...
function loadStep(BgtYear){
	...
	JQ.ajax({
		  type: "POST",
		  url: "?mod=<?php echo LURL::dotPage('report5_action');?>",		   
...
<input type="hidden" name="mod" id="mod" value="<?php echo LURL::dotPage('report5_list');?>" />
