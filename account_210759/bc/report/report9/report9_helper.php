...
class sHelper
{
	...
	*/	
	...
	function getTotalPrjMonth($SourceExId=0,$ScreenLevel=0){
		switch($_REQUEST["ExType"]){
			case "Internal":
					$BGInternal = $this->getTotalPrjMonthInternal($ScreenLevel);
					return $BGInternal;
			break;
			case "External":
					$BGExternal = $this->getTotalPrjMonthExternal($SourceExId,$ScreenLevel);
					return $BGExternal;
			break;
			default:
					$BGInternal = $this->getTotalPrjMonthInternal($ScreenLevel);
	...
	/* Parameter: */
			/* @XXXX	= - */
	/* Return Value : Field */
	function getTotalPrjMonthInternal($ScreenLevel=0){
		$where = array();
		if($_REQUEST["BgtYear"]){
	...
	/* Parameter: */
			/* @XXXX	= - */
	/* Return Value : Field */
	function getTotalPrjMonthExternal($SourceExId=0,$ScreenLevel=0){
		$where = array();
		if($_REQUEST["BgtYear"]){
			$where[] = "t1.BgtYear='".$_REQUEST["BgtYear"]."'";
		}
