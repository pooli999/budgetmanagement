...
switch($KeyPage)
{
	case "indicator":
			...
			$startupPage = "startup";
			$actionPage = "indicator_action";
			$listPage = "indicator_list";
			$addPage = "indicator_add";
			//$confirmPage = "indicator_confirm";
			$sortPage = "indicator_sort";
			$viewPage = "indicator_view";
			$importPage = "indicator_import";
			$importPrjPage = "indicator_import _prj";
			$importActPage = "indicator_import _act";
