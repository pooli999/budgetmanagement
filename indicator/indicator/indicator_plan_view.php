...
function toPage(MonthNo){
	window.location.href='?mod=<?php echo lurl::dotPage("indicator_plan_add");?>&PItemId=<?php echo $_REQUEST["PItemId"];?>&MonthNo='+MonthNo;
}
...
<div style="text-align:center; padding-top:10px; padding-bottom:10px">
	<input type="button" value="ปรับปรุงข้อมูล" class="btnActive" onclick="goPage('?mod=<?php echo lurl::dotPage('indicator_plan_add');?>&PItemId=<?php echo $_REQUEST["PItemId"];?>');" />
	<input type="button" value="ย้อนกลับ" class="btn" onclick="goPage('?mod=<?php echo lurl::dotPage('indicator_plan_list');?>&BgtYear=<?php echo $BgtYear;?>');" />
</div>
