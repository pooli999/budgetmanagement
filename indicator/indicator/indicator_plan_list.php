...
function loadSCT(BgtYear){
	window.location.href='?mod=<?php echo lurl::dotPage('indicator_plan_list');?>&BgtYear='+BgtYear;
}
...
<?php } ?>
    ...
    <td valign="top" >
    (<?php echo $PItemCode; ?>) 
    <a href="?mod=<?php echo LURL::dotPage('indicator_plan_view'); ?>&PItemId=<?php echo $PItemId; ?>"><?php echo $PItemName; ?></a>
    </td>
    ...
    <a href="?mod=<?php echo LURL::dotPage('indicator_plan_add'); ?>&PItemId=<?php echo $PItemId; ?>" class="ico edit">บันทึกผล</a>
    <?php } ?>
    </td>
  </tr>
...
?>
   ...
   <td align="center">&nbsp;</td>
    ...
    <!--<a href="?mod=<?php //echo LURL::dotPage('indicator_view_sub'); ?>">--><?php echo $PIndName; ?><!--</a>-->
    </td>
    <td align="center">&nbsp;</td>
