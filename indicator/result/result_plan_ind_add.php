...
<?php if($CriterionType =="quantity"){?>
  <tr>
    ...
    <td align="center"><input type="text" style="width:85%; text-align:center;" name="QTMTargetResult[10]" id="QTMTargetResult_10" value="<?php echo $get->getPlanQTIndMonthResult($PIndCode,10); ?>" /></td>
    <td align="center"><input type="text" style="width:85%; text-align:center;" name="QTMTargetResult[11]" id="QTMTargetResult_11" value="<?php echo $get->getPlanQTIndMonthResult($PIndCode,11); ?>" /></td>
    <td align="center"><input type="text" style="width:85%; text-align:center;" name="QTMTargetResult[12]" id="QTMTargetResult_12" value="<?php echo $get->getPlanQTIndMonthResult($PIndCode,12); ?>" /></td>
    <td align="center"><input type="text" style="width:85%; text-align:center;" name="QTMTargetResult[1]" id="QTMTargetResult_1" value="<?php echo $get->getPlanQTIndMonthResult($PIndCode,1); ?>" /></td>
    <td align="center"><input type="text" style="width:85%; text-align:center;" name="QTMTargetResult[2]" id="QTMTargetResult_2" value="<?php echo $get->getPlanQTIndMonthResult($PIndCode,2); ?>" /></td>
    <td align="center"><input type="text" style="width:85%; text-align:center;" name="QTMTargetResult[3]" id="QTMTargetResult_3" value="<?php echo $get->getPlanQTIndMonthResult($PIndCode,3); ?>" /></td>
    <td align="center"><input type="text" style="width:85%; text-align:center;" name="QTMTargetResult[4]" id="QTMTargetResult_4" value="<?php echo $get->getPlanQTIndMonthResult($PIndCode,4); ?>" /></td>
    <td align="center"><input type="text" style="width:85%; text-align:center;" name="QTMTargetResult[5]" id="QTMTargetResult_5" value="<?php echo $get->getPlanQTIndMonthResult($PIndCode,5); ?>" /></td>
    <td align="center"><input type="text" style="width:85%; text-align:center;" name="QTMTargetResult[6]" id="QTMTargetResult_6" value="<?php echo $get->getPlanQTIndMonthResult($PIndCode,6); ?>" /></td>
    <td align="center"><input type="text" style="width:85%; text-align:center;" name="QTMTargetResult[7]" id="QTMTargetResult_7" value="<?php echo $get->getPlanQTIndMonthResult($PIndCode,7); ?>" /></td>
    <td align="center"><input type="text" style="width:85%; text-align:center;" name="QTMTargetResult[8]" id="QTMTargetResult_8" value="<?php echo $get->getPlanQTIndMonthResult($PIndCode,8); ?>" /></td>
    <td align="center"><input type="text" style="width:85%; text-align:center;" name="QTMTargetResult[9]" id="QTMTargetResult_9" value="<?php echo $get->getPlanQTIndMonthResult($PIndCode,9); ?>" /></td>
    </tr>
 <?php } ?> 
 ...
 <?php if($CriterionType =="quality"){?>
  <tr>
    ...
    <td align="center"><?php echo $get->getPlanTQLScore($_REQUEST["PIndId"],$get->getPlanQLIndMonthResult($PIndCode,10),"QLMTargetResult[10]");?></td>
    <td align="center"><?php echo $get->getPlanTQLScore($_REQUEST["PIndId"],$get->getPlanQLIndMonthResult($PIndCode,11),"QLMTargetResult[11]");?></td>
    <td align="center"><?php echo $get->getPlanTQLScore($_REQUEST["PIndId"],$get->getPlanQLIndMonthResult($PIndCode,12),"QLMTargetResult[12]");?></td>
    <td align="center"><?php echo $get->getPlanTQLScore($_REQUEST["PIndId"],$get->getPlanQLIndMonthResult($PIndCode,1),"QLMTargetResult[1]");?></td>
    <td align="center"><?php echo $get->getPlanTQLScore($_REQUEST["PIndId"],$get->getPlanQLIndMonthResult($PIndCode,2),"QLMTargetResult[2]");?></td>
    <td align="center"><?php echo $get->getPlanTQLScore($_REQUEST["PIndId"],$get->getPlanQLIndMonthResult($PIndCode,3),"QLMTargetResult[3]");?></td>
    <td align="center"><?php echo $get->getPlanTQLScore($_REQUEST["PIndId"],$get->getPlanQLIndMonthResult($PIndCode,4),"QLMTargetResult[4]");?></td>
    <td align="center"><?php echo $get->getPlanTQLScore($_REQUEST["PIndId"],$get->getPlanQLIndMonthResult($PIndCode,5),"QLMTargetResult[5]");?></td>
    <td align="center"><?php echo $get->getPlanTQLScore($_REQUEST["PIndId"],$get->getPlanQLIndMonthResult($PIndCode,6),"QLMTargetResult[6]");?></td>
    <td align="center"><?php echo $get->getPlanTQLScore($_REQUEST["PIndId"],$get->getPlanQLIndMonthResult($PIndCode,7),"QLMTargetResult[7]");?></td>
    <td align="center"><?php echo $get->getPlanTQLScore($_REQUEST["PIndId"],$get->getPlanQLIndMonthResult($PIndCode,8),"QLMTargetResult[8]");?></td>
    <td align="center"><?php echo $get->getPlanTQLScore($_REQUEST["PIndId"],$get->getPlanQLIndMonthResult($PIndCode,9),"QLMTargetResult[9]");?></td>
    </tr>
 <?php } ?> 
...
<input type="button" class="btn" name="Cancel" id="Cancel" value="ยกเลิก" onclick="goPage('?mod=<?php echo lurl::dotPage("result_planmonth");?>&PItemCode=<?php echo $PItemCode;?>');"  />
</div>
