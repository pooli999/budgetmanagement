...
window.location.href='?mod=<?php echo lurl::dotPage($addPage);?>&PrjId=<?php echo $_REQUEST["PrjId"];?>&PrjActId=<?php echo $_REQUEST["PrjActId"];?>&PrjDetailId=<?php echo $_REQUEST["PrjDetailId"];?>&PrjActCode=<?php echo $_REQUEST["PrjActCode"];?>&OrgCode=<?php echo $_REQUEST["OrgCode"];?>&BgtYear=<?php echo $_REQUEST["BgtYear"];?>&pageid='+pageid;
}
...
<table width="100%" border="0" cellspacing="1" cellpadding="6" class="tbl-list" >
  <tr>
    ...
    <td class="require" >*</td>
    <td  style="color:#03F ">
    <input type="text" name="Progress" id="Progress" value="<?php echo $Progress;?>" onKeyPress="return validChars(event,1)" /> (เป็นตัวเลขเท่านั้น)</td>
  </tr>
  <tr>
