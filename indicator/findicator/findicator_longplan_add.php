...
?>        
        <tr style="vertical-align:top;">
          ...
          <input type="text" style="width:90px; text-align:center;" name="YearTargetResult[]" value="<?php echo $YearTargetResult; ?>" />
          </td>
...
<div style="text-align:center; padding-top:10px; padding-bottom:10px">
	...
	<input type="button" name="button" id="button" value="ยกเลิก" class="btn" onclick="goPage('?mod=<?php echo lurl::dotPage('findicator_longplan_list');?>&PLongCode=<?php echo $PLongCode;?>');" />
</div>
