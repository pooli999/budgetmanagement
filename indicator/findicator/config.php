...
switch($KeyPage)
{
	case "findicator":
			...
			$startupPage = "startup";
			$actionPage = "findicator_action";
			$listPage = "findicator_list";
			$addPage = "findicator_add";
			//$confirmPage = "findicator_confirm";
			$sortPage = "findicator_sort";
			$viewPage = "findicator_view";
			$importPage = "findicator_import";
			$importPrjPage = "findicator_import _prj";
			$importActPage = "findicator_import _act";
...
$GLOBALS["importPage"] = $importPage;
$GLOBALS["importPrjPage"] = $importPrjPage;
$GLOBALS["importActPage"] = $importActPage;
