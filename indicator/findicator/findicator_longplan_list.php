...
function loadSCT(PLongCode){
	window.location.href='?mod=<?php echo lurl::dotPage('findicator_longplan_list');?>&PLongCode='+PLongCode;
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl-tab">
  <tr>
    ...
    <td class="notcurrent"><a href="?mod=<?php echo LURL::dotPage('findicator_plan_list'); ?>&BgtYear=<?php echo ($_REQUEST["BgtYear"])?$_REQUEST["BgtYear"]:(date("Y")+543); ?>">ตัวชี้วัดแผนงาน</a></td>
...
<?php } ?>
    ...
    <td valign="top" >
      (<?php echo $LPlanCode; ?>) 
      <a href="?mod=<?php echo LURL::dotPage('findicator_longplan_view'); ?>&LPlanId=<?php echo $LPlanId; ?>"><?php echo $LPlanName; ?></a>
    </td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
?>
   ...
   <td align="center">&nbsp;</td>
    <td>
      ...
      <!--<a href="?mod=<?php //echo LURL::dotPage('findicator_longplan_view_sub'); ?>">--><?php echo $LindName; ?><!--</a>-->
    </td>
