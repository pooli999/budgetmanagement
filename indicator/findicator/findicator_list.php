...
<?php } ?>
    ...
    <td valign="top" >
    (<?php echo $PrjCode; ?>) 
    <a href="?mod=<?php echo LURL::dotPage('findicator_view'); ?>&PrjDetailId=<?php echo $PrjDetailId; ?>"><?php echo $PrjName; ?></a>
    </td>
...
?>
   ...
   <td align="center">&nbsp;</td>
    ...
    <!--<a href="?mod=<?php //echo LURL::dotPage('findicator_view_sub'); ?>">--><?php echo $IndicatorName; ?><!--</a>-->
    </td>
    <td align="center">&nbsp;</td>
