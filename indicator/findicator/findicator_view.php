...
function toPage(MonthNo){
	window.location.href='?mod=<?php echo lurl::dotPage("findicator_add");?>&PrjDetailId=<?php echo $_REQUEST["PrjDetailId"];?>&MonthNo='+MonthNo;
}
...
<div style="text-align:center; padding-top:10px; padding-bottom:10px">
	<input type="button" value="ย้อนกลับ" class="btn" onclick="goPage('?mod=<?php echo lurl::dotPage('findicator_list');?>&BgtYear=<?php echo $BgtYear;?>');" />
</div>
