...
function toPage(BgtYear){
	window.location.href='?mod=<?php echo lurl::dotPage("findicator_longplan_add");?>&LPlanId=<?php echo $_REQUEST["LPlanId"];?>&BgtYear='+BgtYear;
}
...
<div style="text-align:center; padding-top:10px; padding-bottom:10px">
	<input type="button" value="ย้อนกลับ" class="btn" onclick="goPage('?mod=<?php echo lurl::dotPage('findicator_longplan_list');?>&PLongCode=<?php echo $PLongCode;?>');" />
</div>
