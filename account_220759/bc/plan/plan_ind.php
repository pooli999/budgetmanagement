...
<table width="100%" border="0" cellspacing="1" cellpadding="1" class="tbl-view" style="margin-bottom:0px;">
    ...
    <tr>
      ...
      <td class="require">*</td>
      <td><div><?php echo $get->getIndList($IndCode);?></div></td>
    </tr>
    <tr>
    <th>รหัสตัวชี้วัด</th>
    <td class="require">&nbsp;</td>
...
<input type="hidden" name="LindCode" id="LindCode" value="<?php echo $LindCode; ?>" />
    </td>
</tr>
<tr style="vertical-align:top;">
    <th>ชื่อตัวชี้วัด</th>
    <td class="require">*</td>
    <td>
<div id="ind-name" style="padding-top:8px; padding-bottom:8px;"><?php //$get->getIndName($IndCode); ?></div>
<textarea style="width:99%; height:50px;" name="LindName" id="LindName"><?php echo $LindName; ?></textarea>
	</td>
</tr>
<tr style="vertical-align:top;">
...
<tr style="vertical-align:top;">
    ...
    <?php echo ePerson(array('name'=>'PersonalSelect[]','id'=>'PersonalSelect','value'=>implodeString($get->getTaskPerson($LindCode),'PersonalCode'),'selecttype'=>'multi'));?>
    </td>
</tr>
<tr>
    <th>หน่วยนับ</th>
...
<input type="radio" name="UnitPosition" <?php if(($UnitPosition == "") || ($UnitPosition=="back") ){ ?> checked="checked" <?php } ?> value="back" />อยู่หลังค่าข้อมูล
    </td>
</tr>
</table>
