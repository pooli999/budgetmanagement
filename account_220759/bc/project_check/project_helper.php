...
/*	function getMaxScreenLevel(){
	...
	function getPlanItemList($BgtYear=0,$PGroupId=10,$selected=0,$tag_attribs='onchange="loadPrj(this.value)"',$tag_name='PItemCode',$lebel='เลือก'){
		return $this->dpublic->getPlanItemList($BgtYear,$PGroupId,$selected,$tag_attribs,$tag_name,$lebel);
	}
...
/*	function getTaskPerson($PrjDetailId)
	...
	*/
	...
	function getOrgList($BgtYear=0){
		...
		$sql = "select t1.*,t2.OrgShortName,t2.OrgName "
