...
/*		$SumBGTotal=0;
   ...
   <tr>
    ...
    <tr>
      	<th style="width:40%; text-align:center">ชื่อตัวชี้วัดกิจกรรม</th>
        <th style="width:20%; text-align:center">ประเภทตัวชี้วัด</th>
        <th style="width:15%; text-align:center">ค่าเป้าหมาย</th>
        <th style="width:15%; text-align:center">หน่วยนับ</th>
