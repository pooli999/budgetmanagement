...
{
	case "initproject":
			$PathUpload = VSROOT.'upload/initproject/';
			$startupPage = "startup";
			$actionPage = "initproject_action";
			$listPage = "initproject_list";
			$addPage = "initproject_add";
			$addPersonPage = "initproject_addperson";
			//$confirmPage = "initproject_confirm";
			$viewPage = "initproject_view";
			$sortPage = "initproject_sort";
...
$GLOBALS["addPersonPage"] = $addPersonPage;
