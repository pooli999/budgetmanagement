...
class sHelper
{
	...
	*/	
	...
	function getTotalPrjMonth($PItemCode=0,$PrjDetailId=0,$PrjActId=0,$SourceExId=0){
		$BGInternal = $this->getTotalPrjMonthInternal($PItemCode,$PrjDetailId,$PrjActId);
		$BGExternal = $this->getTotalPrjMonthExternal($PItemCode,$PrjDetailId,$PrjActId,$SourceExId);
	...
	/* Parameter: */
			/* @XXXX	= - */
	/* Return Value : Field */
	function getTotalPrjMonthInternal($PItemCode=0,$PrjDetailId=0,$PrjActId=0){
		$where = array();
		if($_REQUEST["BgtYear"]){
			$where[] = "t1.BgtYear='".$_REQUEST["BgtYear"]."'";
		}
	...
	/* Parameter: */
			/* @XXXX	= - */
	/* Return Value : Field */
	function getTotalPrjMonthExternal($PItemCode=0,$PrjDetailId=0,$PrjActId=0,$SourceExId=0){
		$where = array();
		if($_REQUEST["BgtYear"]){
			$where[] = "t1.BgtYear='".$_REQUEST["BgtYear"]."'";
		}
