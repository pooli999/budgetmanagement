...
<input type="hidden" name="CostTypeId" id="CostTypeId" value="<?php echo $_REQUEST["CostTypeId"]; ?>" />
  ...
  foreach($BGCate as $BGCateRow){ 
	...
	$SumTotalCost=$get->getTotalPrjExternalX4($_REQUEST["BgtYear"],$_REQUEST["OrganizeCode"],0,0,0,0,$_REQUEST["SCTypeId"],$_REQUEST["ScreenLevel"],$_REQUEST["SourceExId"],0,0,$CostTypeId,0,0);
  ...
  foreach($BGLevel1 as $BGLevel1Row){ 
  	foreach($BGLevel1Row as $c=>$d){
		${$c} = $d;
			...
			$SumTotalCost=$get->getTotalPrjExternalX4($_REQUEST["BgtYear"],$_REQUEST["OrganizeCode"],0,0,0,0,$_REQUEST["SCTypeId"],$_REQUEST["ScreenLevel"],$_REQUEST["SourceExId"],$CostItemCode,$ParentCode,$CostTypeId,$LevelId,$HasChild);
  ...
  foreach($BGLevel3 as $BGLevel3Row){ 
  	foreach($BGLevel3Row as $g=>$h){
		${$g} = $h;
			...
			$SumTotalCost=$get->getTotalPrjExternalX4($_REQUEST["BgtYear"],$_REQUEST["OrganizeCode"],0,0,0,0,$_REQUEST["SCTypeId"],$_REQUEST["ScreenLevel"],$_REQUEST["SourceExId"],$CostItemCode,$ParentCode,$CostTypeId,$LevelId,$HasChild);
			// $SumTotalCost=$get->getTotalPrjExternalX4($_REQUEST["BgtYear"],$_REQUEST["OrganizeCode"],0,$PrjId,$PrjDetailId,0,$_REQUEST["SCTypeId"],$_REQUEST["ScreenLevel"],$SourceExId,$CostItemCode,$ParentCode,$CostTypeId,$LevelId,$HasChild);
  ...
  <!--END วน loop หมวดงบรายจ่าย-->
  	<?php  
	$SumCost=$get->getTotalPrjExternalX4($_REQUEST["BgtYear"],$_REQUEST["OrganizeCode"],0,0,0,0,$_REQUEST["SCTypeId"],$_REQUEST["ScreenLevel"],$_REQUEST["SourceExId"],0,0,$_REQUEST["CostTypeId"]);
	?>
