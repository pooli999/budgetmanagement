...
<table width="100%" border="0" class="tbl-list tablesorter"  cellspacing="0">
    ...
    <th style="text-align:center;width:100px;" ><input id="savesend" class="btnRed" type="button" onclick="Save('adminForm','send');" value=" POST " name="save2" /></th>
    </tr>
<thead>
  <tr>
...
?>
  <tr>
    ...
    <td align="center" valign="top" nowrap="nowrap"><input name="CboSendId" type="checkbox"  value="<?php echo $AcActionId ;?>" <?php if ($PostStatus == "1"){?>checked="checked"<? }?> /></td>
    </tr>
