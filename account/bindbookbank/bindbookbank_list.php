...
function icoEdit($r){
	...
	vprintf('<a href="%s" class="%s" title="%s"><span>%s</span></a>',array(
		"javascript:self.location='?mod=".LURL::dotPage($addPage)."&id=".$r->BookbankId."&BookbankAcId=".$r->BookbankAcId."&AcGroupId=".$r->AcGroupId."&AcSeriesId=".$r->AcSeriesId."&AcSeriesName=".$r->AcSeriesName."&start=".$_REQUEST["start"]."'",
		'ico edit',
		$label,
		$label
	));
...
<thead>
  <tr>
    ...
    <th align="left" >บัญชีธนาคาร</th>
    <th align="left">ธนาคาร</th>
    <th align="left">สาขา</th>
    <th align="left">ประเภท</th>
    <th align="left">ผูกบัญชีย่อย</th>
...
?>
  <tr>
    ...
    <td valign="top" ><?php // echo icoView($r);?><?php echo $BookbankNumber;?></td>
    <td valign="top" ><?php echo $BankName;?></td>
    <td valign="top" ><?php echo $Branch;?></td>
    <td valign="top" ><?php echo $BookbankType;?></td>
    <td valign="top" ><?php if($acName){?><?php echo $acName;?><?php }?></td>
