...
function icoEdit($r){
	...
	vprintf('<a href="%s" class="%s" title="%s"><span>%s</span></a>',array(
		"javascript:self.location='?mod=".LURL::dotPage($addPage)."&id=".$r->BgtYearId."&start=".$_REQUEST["start"]."'",
		'ico edit',
		$label,
		$label
	));
...
<thead>
  <tr>
    ...
    <th align="left"  style="text-align:center;">ปีงบประมาณ</th>
    <th align="center" style="width:50%;text-align:center;">ชื่อชุดผังบัญชี</th>
...
?>
  <tr>
    ...
    <td align="center" valign="top" ><?php // echo icoView($r);?><?php echo $BgtYear;?></td>
    <td  align="center"valign="top" ><?php echo $SeriesName;?></td>
    <td style="width:120px;text-align:center;" nowrap="nowrap" valign="top"  ><?php echo icoEdit($r);?></td>
  </tr>
