...
<input name="journalId" type="hidden"  id="journalId" value="<?php echo $_REQUEST['id'];?>" />
...
<tr>
<th><span class="no" style="width:130px">รหัสสมุดบัญชีรายวัน</span></th>
<td class="require">*</td>
<td><input name="shortName" type="text" id="shortName" value="<?php echo $shortName;?>" size="15" /></td>
</tr>
<tr>
<th><span class="no" style="width:130px">ชื่อสมุดบัญชีรายวัน</span></th>
<td class="require">*</td>
<td><input name="journalName" type="text" id="journalName" value="<?php echo $journalName;?>" size="45" /></td>
</tr>
 <tr>
    <th>&nbsp;</th>
    <td>&nbsp;</td>
