...
function icoEdit($r){
	...
	vprintf('<a href="%s" class="%s" title="%s"><span>%s</span></a>',array(
		"javascript:self.location='?mod=".LURL::dotPage($addPage)."&id=".$r->journalId."&start=".$_REQUEST["start"]."'",
		'ico edit',
		$label,
		$label
	));
...
<thead>
  <tr>
    <th class="no" style="width:130px">รหัสสมุดรายวัน</th>
    <th align="left" >ชื่อสมุดรายวัน</th>
...
?>
  <tr>
    <td valign="top" class="center" ><?php echo $shortName ;?></td>
    <td valign="top" ><?php // echo icoView($r);?><?php echo $journalName;?></td>
    <td style="width:60px;" nowrap="nowrap" valign="top"  ><?php if ($journalId >3){echo icoEdit($r);}?></td>
    <td style="width:60px;" valign="top"  nowrap="nowrap" ><?php if ($journalId >3){echo icoDelete($r);}?></td>
  </tr>
