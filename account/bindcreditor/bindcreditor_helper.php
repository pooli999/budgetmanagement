	...
	*/
	function getDataList(&$list,$limit=20){
		if($_REQUEST["AcSeriesId"]!="0"){
			...
			$where = " and ac_chart.AcSeriesId =".$_REQUEST["AcSeriesId"]." and ac_chart.DeleteStatus='N'";

			$sql = "select CONCAT(AcChartCode,' | ',ThaiName) as nname from ac_chart where AcMainType = 'C' ".$where;
			//echo $sql;
