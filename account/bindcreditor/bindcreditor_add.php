...
function loadAC(){
	...
	JQ.ajax({
		  type: "GET",
		  url: "?mod=<?php echo LURL::dotPage('bindcreditor_action');?>",
...
<div class="sysinfo">
  <div class="sysname"><? if ($_REQUEST["CashAcId"] == ""){?>เพิ่มรายการ<? }else{?>แก้ไขรายการ<? }?><?php echo $MenuName;?></div>
...
<input name="CashId" type="hidden"  id="CashId" value="<?php echo $_REQUEST['id'];?>" />
<input name="CashAcId" type="hidden"  id="CashAcId" value="<?php echo $_REQUEST['CashAcId'];?>" />
...
<input name="CashName" type="hidden"  id="CashName" value="<?php echo $CashName;?>" />
