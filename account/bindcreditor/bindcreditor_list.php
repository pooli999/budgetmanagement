...
function icoEdit($r){
	...
	vprintf('<a href="%s" class="%s" title="%s"><span>%s</span></a>',array(
		"javascript:self.location='?mod=".LURL::dotPage($addPage)."&id=".$r->CashId."&CashAcId=".$r->CashAcId."&AcGroupId=".$r->AcGroupId."&AcSeriesId=".$_REQUEST["AcSeriesId"]."&AcSeriesName=".$_REQUEST["AcSeriesName"]."&start=".$_REQUEST["start"]."'",
		'ico edit',
		$label,
		$label
	));
...
?>
  <tr>
    ...
    <td valign="top" >บัญชีคุมเจ้าหนี้</td>
    <td valign="top" ><?php echo $nname;?></td>
