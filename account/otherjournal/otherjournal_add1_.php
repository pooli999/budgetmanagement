...
function Save(f){
	if(ValidateForm(f)){
		 ...
		 toSubmit(f,'save1',action_url,redirec_url);
	}
}
...
function toFixed(num, pre){
	...
	/*		JQ(".findcode").live('change',function(){
			...
			//loaddata(<?//=$AcActionId?>); //  ผูกบัญชีรายจ่าย
			create_tblacc();
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="4" class="tbl-view">
      <tr>
        ...
        <td width="30%" bgcolor="f5f2ed">
            ...
            <!--<input id = "findcode1" name = "findcode1" class = "findcode" type="hidden" value = "" /> ไม่ใช้มั้ง-->
        </td>
      ...
      <tr>
       ...
       <!-- <input id = "PartnerCode" name = "PartnerCode" type="hidden" value = "<? //= $PartnerCode?>" />-->
        <select name="ptyep" id="ptyep" onchange="loadpn()">
          ...
          <option value="2">บุลคลภายใน</option>
        </select>
      ...
      <tr>
        ...
        <fieldset>
        	...
        	<table width="100%" border="0" cellspacing="1" cellpadding="4">
                  <tr>
                    <th style="width:300px" align="center" bgcolor="#f5f2ed">เลขที่ สช.น</th>
                    <th style="width:300px" align="center" bgcolor="#f5f2ed">รหัสโครงการ</th>
                    <th align="center" style="width:800px" bgcolor="#f5f2ed">คำอธิบาย</th>
		...
		//							foreach( $r1 as $k1=>$v1){ ${$k1} = $v1;}
                  ...
                  <tr>
                    <td align="center" bgcolor="#FFFFE6">
                    	 <input id = "DocCode" name = "DocCode" type="text" value = "<?= $DocCode?>" />
                    </td>
                    <td bgcolor="#FFFFE6" align="left">
						 <input id = "PrjCode" name = "PrjCode" type="text" value = "<?= $PrjCode?>" />
                    </td>
                    <td bgcolor="#FFFFE6" align="left">
						<input name="PaymentListDetailId<? //=$iall?>" id="PaymentListDetailId<?=$iall?>" type="hidden" value="<? //=$PaymentListDetailId?>" />
						<textarea name="DetailCostAccount" id = "DetailCostAccount" cols="100" rows="3" maxlength="1000"><? //=$DetailCostAccount?></textarea>
                    </td>
...
%</td>
                        ...
                        <td bgcolor="f5f2ed">
                          ...
                          <!--<input id = "TaxW" name = "TaxW" type="text" value = "<?//= $TaxW?>" />-->
