    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="4" class="tbl-view">
      <tr>
        ...
        <td width="30%" bgcolor="f5f2ed">
        	<?= $PV?>
            <input id = "PV" name = "Pv" type="hidden" value = "<?= $PV?>" />  <input id = "findcode1" name = "findcode1" class = "findcode" type="hidden" value = "" /><input id = "MaxLine" name = "MaxLine" type="hidden" />
        </td>
      ...
      <tr>
        ...
        <td colspan="6" bgcolor="f5f2ed">
            <fieldset>
            <legend><strong>รายละเอียดการรับเงิน</strong></legend>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="13%">ประเภทการรับเงิน</td>
                    <td width="87%">
					<?
                    if ($ReceiveType == 1){
						echo "เงินสด";
                   ...
                   <tr>
                    ...
                    if ($ReceiveType == 1){
						...
						echo "ธนาคาร ".$BankId." เลขที่บัญชี ".$BookbankId;
					}else if ($ReceiveType == 3){
						echo "เลขที่เช็ค ".$CheckNumber." "."วันที่เช็ค ".$CheckDate;
					}else if ($ReceiveType == 4){
						echo "เลขที่ ".$BondNumber;
					}else if ($ReceiveType == 5){
						echo "ชื่อธนาคาร ".$GuaranteeBankId."  เลขที่ ".$GuaranteeNumber;
					}
					?></td>
                  </tr>
                  <tr>
                    <td>จำนวนเงิน</td>
                    <td><? echo number_format($IncomeValue,2)?></td>
                  </tr>
                </table>
             </fieldset>
        </td>
