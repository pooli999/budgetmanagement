		 ...
		 <tr>
			<td colspan="6" bgcolor="f5f2ed">
				...
				<legend><strong>คำอธิบาย</strong></legend>
					...
					?>
					<textarea id="PaymentDetailAccount" maxlength="1500" rows="2" cols="215" name="PaymentDetailAccount" class="input_style2"><?php
						echo $PaymentDetailAccount;
					?></textarea>
				</fieldset>
			</td>
		</tr>
