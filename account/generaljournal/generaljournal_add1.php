...
function loaddata(AcActionId){
	...
	JQ.ajax({
	  ...
	  async: false,
	  url: "?mod=<?php echo LURL::dotPage('generaljournal_action');?>",
	  data: "action=findeaccountadd&AcActionId="+AcActionId+"&PaymentId=<?=$_REQUEST["id"]?>",
	  success: function(result3){
...
function create_tblacc(){ // สร้างตาราง แสดงรายการ
	str = '<table width="100%" border="0" align="left" cellpadding="4" cellspacing="1" >';
      ...
      // str = str+'</tr>';
        ...
        str = str+'<th width="20" style="width:20px;" align="center" class = "iTd style4";bgcolor="808080"> No.</td>';
        str = str+'<th align="center" class = "iTd style4">Account</th>';
        //str = str+'<th width="250" align="center" class = "iTd style4">Account Name</td>';
        str = str+'<th width="150" style="width:150px;" align="center" class = "iTd style4">Detail</th>';
        str = str+'<th width="50" style="width:50px;" align="center" class = "iTd style4">Debit</th>';
        str = str+'<th width="50" style="width:50px;" align="center" class = "iTd style4">Credit</th>';
      str = str+'</tr>';
			 line =1;
			 max_dr = 0;
			 vdr = 0;
			 ...
			 max_cr = 0;
				for (list_d = 0;list_d < arr_ac_chart_id.length;list_d++){
					  str = str+'<tr class="iRow" list_d = '+list_d+'>';
							str = str+'<td height="25" bgcolor="#FFFFBB" align="center" class = "iTd">'+line+'</td>';
						str = str+'<td align="left" bgcolor="#FFFFBB" class = "iTd">';
							...
							str = str+'<input name="AcChartCode'+list_d+'" type="text" id = "AcChartCode'+list_d+'" class="input_style2 findcode clearrow" value="'+arr_AcChartCode[list_d]+'" size="120"/>';
						str = str+'</td>';
						// str = str+'<td align="left" bgcolor="#FFFFBB"class = "iTd">';
	...
	str = str+'<td align="left" bgcolor="#FFFFBB" class = "iTd">';
		...
		str = str+'<input name="AcChartCode'+list_d+'" type="text" id = "AcChartCode'+list_d+'" class="input_style2 findcode clearrow" value="" size="120" maxlength="18"/>';
	str = str+'</td>';
	// str = str+'<td align="left" bgcolor="#FFFFBB"class = "iTd">';
        ...
        <td bgcolor="f5f2ed">
			    <select name="ptyep" id="ptyep" onchange="loadpn()">
			      ...
			      <option value="2" <?php if ($PType == "2"){?>selected="selected"<?php }?>>บุลคลภายใน</option>
					...
					<input id = "PartnerCodeedit" name = "PartnerCodeedit" type="hidden" value = "<?php echo $PartnerCode;?>" />
			...
			<fieldset>
				<legend>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="4">
						<tr>
							<th style="width:150px" align="center" bgcolor="#f5f2ed">ปีงบประมาณ</th>
							<th style="width:150px" align="center" bgcolor="#f5f2ed">รหัสกิจกรรม</th>
							<th style="width:150px" align="center" bgcolor="#f5f2ed">เลขที่ สช.น</th>
				...
				?>
						<tr>
							<td align="center" bgcolor="#FFFFE6">
								<input id = "YYear" name = "YYear" type="text" value = "<?php echo $YYear?>"/>
							</td>

							<td align="center" bgcolor="#FFFFE6">
								<input id = "PrjCode" name = "PrjCode" type="text" value = "<?PHP echo $PrjCode?>" />
							</td>

							<td bgcolor="#FFFFE6" align="left">
								<input id = "DocCode" name = "DocCode" type="text" value = "<?php echo $DocCode?>" />
							</td>

							<td bgcolor="#FFFFE6" align="left">
								<input name="PaymentListDetailId" id="PaymentListDetailId" type="hidden" value="<? //=$PaymentListDetailId?>" />
								<textarea name="DetailCostAccount" id = "DetailCostAccount" cols="90px" rows="3" maxlength="1000"><?PHP echo $DetailCostAccount;?></textarea>
							</td>
        ...
        <legend><strong>รายละเอียดการจ่ายเงิน</strong></legend>
        	<table width="100%" border="0" cellspacing="1" cellpadding="4">
                  <tr>
                        ...
                        <td bgcolor="f5f2ed">
						  ...
						  ?>
                          <select name="ChequeOrCash" id="ChequeOrCash">
                             <option value="" ></option>
                             <option value="1" <?php if ($ChequeOrCash == "1"){?>selected="selected"<?php }?>>เงินโอน/เช็ค</option>
                             <option value="2" <?php if ($ChequeOrCash == "2"){?>selected="selected"<?php }?>>เงินสด</option>
                           </select>
                      ...
                      <tr>
                        ...
                        <td bgcolor="f5f2ed" width = 275>
													<div id="bbNumber">
														<?php
                                $tag_attribs = 'onchange="" style="width:180px"';
                                 $get->getBookbankNumber("BookbankId",$tag_attribs,$BookbankId,"-",$BankId);//$tag_name,$tag_attribs,$selected,$lebel
                            ?>
                        	</div>
                        </td>
                        <th bgcolor="f5f2ed">เลขที่เช็ค</th>
                        <td bgcolor="f5f2ed">
                        <input id = "PaymentNumber" name = "PaymentNumber" type="text" value = "<?= $PaymentNumber?>" /></td>
                        </tr>
                       <tr>
                        ...
                        <td bgcolor="f5f2ed">
							...
							?>
                          <input id = "PaymentValue" name = "PaymentValue" type="text" value = "<?= $PaymentValue?>" />
                      <!--<input id = "CashValue" name = "CashValue" type="hidden" value = "<? //= $CashValue?>" />--> บาท </td>
                        </tr>
                       <tr>
                        <th bgcolor="f5f2ed">ภาษีหักมูลค่าเพิ่ม</th>
                       <td bgcolor="f5f2ed"><?//=$Tax?>
					            	<select name="Tax" id="Tax">
							             <option value="" selected="selected">-</option>
							             <option value="7" <?PHP if ($Tax == "7"){?>selected="selected" <?PHP }?>>7</option>
							             <option value="10" <?PHP if ($Tax == "10"){?>selected="selected" <?PHP }?>>10</option>
						           	</select> %
         <!--  <input id = "Tax" name = "Tax" type="text" value="<?//=$Tax?>"/>-->
                        ...
                        <td bgcolor="f5f2ed">
                        	...
                        	<select name="TaxW" id="TaxW">
                             <option value=""></option>
                             <option value="0" <?PHP if ($TaxW == "0"){?>selected="selected" <?PHP }?>>ไม่หักภาษี</option>
                             <option value="1" <?PHP if ($TaxW == "1"){?>selected="selected" <?PHP }?>>1% จากยอดเต็ม </option>
                             <option value="2" <?PHP if ($TaxW == "2"){?>selected="selected" <?PHP }?>>1% ก่อน vat
														 </option>
                           </select> %


                         <label id = "lblTaxWValue" ></label>
