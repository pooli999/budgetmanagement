...
/*	function getCountSubSCType($BgtYear,$SCTypeId){
	...
	function getIndList($BgtYear=0,$selected=0,$tag_attribs='onchange="loadIndName(this.value)" style="width:99%"',$tag_name='PIndCode',$lebel='ระบุ'){
		$where = array();
		$where[] ="t2.BgtYear='".$BgtYear."'";
		if(count($where)) {
			$where_r = "WHERE ". implode( " AND ", $where );
	...
	function getLastRunningNo($PrjCode){
