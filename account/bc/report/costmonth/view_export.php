<?php if($_REQUEST["BgtYear"]){ ?><div>ปีงบประมาณ : <?php echo $_REQUEST["BgtYear"]; ?></div><?php } ?>
<?php if($_REQUEST["PItemCode"]){ ?><div>ชื่อแผนงาน : <?php echo $get->getPItemCode($_REQUEST["PItemCode"]); ?></div><?php } ?>
