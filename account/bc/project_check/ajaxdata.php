...
switch($_REQUEST["section"])
{
	...
	case "getOrganizeCode":
			$get->getOrganizeCode($_REQUEST["BgtYear"]);
	break;		
	
	case "getPlanItemList":
			$get->getPlanItemList($_REQUEST["BgtYear"]);
	break;		

	case "getProjectList":
			$get->getProjectList($_REQUEST["BgtYear"],$_REQUEST["PItemCode"],$_REQUEST["OrganizeCode"]);
	break;
	...
	case "getRecordActivity":
			 $get->getRecordActivity($_REQUEST["n"]);
	break;

	case "getProjectList":
			 $get->getProjectList($_REQUEST["SCTypeId"]);
	break;
/******************************************************************************/
	case "getCostDetail":
			 $get->getCostDetail($_REQUEST["PrjActId"]);
	break;
	
	case "getCostDetailEx":
			 $get->getCostDetailEx($_REQUEST["PrjActId"],$_REQUEST["SourceExId"]);
	break;
