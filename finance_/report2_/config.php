...
$SSN =&JFactory::getSession();
$sessDepartmentId = $SSN->get('Profile')->DepartmentId;
$sessUserGroup = $SSN->get('Profile')->UserGroup;
$sessUserGroupId = $sessUserGroup[1];
...
switch($KeyPage)
{
	...
	case "report2":
			$PathUpload = VSROOT.'upload/durable/';
			$startupPage = "startup";
			$actionPage = $KeyPage."_action";
			$listPage = $KeyPage."_list";
			$addPage = $KeyPage."_add";
			$confirmPage = $KeyPage."_confirm";
			$viewPage = $KeyPage."_view";
			$ajaxPage = $KeyPage."_ajaxdata";
			$viewItemPage = $KeyPage."_view_item";
			$editItemPage = $KeyPage."_edit_item";
			$confirmItemPage = $KeyPage."_confirm_item";
...
$GLOBALS["viewItemPage"] = $viewItemPage;
$GLOBALS["editItemPage"] = $editItemPage;
