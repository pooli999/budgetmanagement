...
<legend ><b>รายการที่จ่ายเงินสดย่อย</b></legend>
  <table width="100%" border="0" cellpadding="1" cellspacing="1" class="tbl-list-sub">
    <tr>
      ...
      <th bgcolor="A6A5B3">จำนวนเงิน</td>
      <th bgcolor="A6A5B3" style="width:200px; text-align:center;"><input type="checkbox" name="checkbox4" value="checkbox" /></th>
    </tr>
    <tr>
      ...
      <td align="center" bgcolor="E6E6E6" style="width:200px; text-align:center;"><input name="checkbox" type="checkbox" value="checkbox" checked="checked" /></th>    </tr>
    <tr>
...
ชื่อผู้ปฏิบัติงาน : นางสาวทดสอบ </td>
      ...
      <td align="center" style="width:200px; text-align:center;"><input name="checkbox2" type="checkbox" value="checkbox" checked="checked" /></th>    </tr>
    <tr>
...
ชื่อผู้ปฏิบัติงาน : นางสาวทดสอบ </td>
      <td bgcolor="E6E6E6" style="width:200px; text-align:right;">1,000</td>
      <td align="center" bgcolor="E6E6E6" style="width:200px; text-align:center;"><input name="checkbox3" type="checkbox" value="checkbox" checked="checked" /></th>    </tr>
    <tr>
...
ชื่อผู้ปฏิบัติงาน : นางสาวทดสอบ </td>
      ...
      <td align="center" style="width:200px; text-align:center;"><input type="checkbox" name="checkbox3" value="checkbox" /></th>    </tr>
    <tr>
      <td colspan="3" style="text-align:right;">จำนวนเงินรวม&nbsp;</th>
      <td style="width:200px; text-align:right;"><strong>2,400</strong></td>
      <td align="center">&nbsp;</th></tr>
    <tr>
      <td colspan="3" style="text-align:right;">เงินสดย่อยคงเหลือ&nbsp;</th>
      <td style="width:200px; text-align:right;"><span class="style1">60,000</span></td>
      <td align="center">&nbsp;</th>    </tr>
    <tr>
      <td colspan="5" style="text-align:center;"><input type="button" name="button42" id="button42" value="บันทึก" class="btnActive" onclick="goPage('?mod=<?php echo lurl::dotPage($listPage);?>&amp;id=<?php echo $_REQUEST['id'];?>');">
        <input name="cancel2" type="button" value="ยกเลิก" class="btn cancle" onclick="history.back(-1);" />          </tr>
</table>
  </fieldset>
</form>
</div>
