...
<table width="100%" border="0" cellspacing="0" cellpadding="3" align="center">
  ...
  <tr>
    <td colspan="2"  style="text-indent:40px; text-align:justify"><?php $dataRefer = $get->getDataDocCodeRefer($DocCodeRefer); //ltxt::print_r($dataRefer); ?>
      อ้างถึงบันทึกข้อความขออนุมัติหลักการเลขที่ สช.น <span class="textcolor"><?php echo $DocCodeRefer; ?></span> ลงวันที่ <span class="textcolor"><?php echo ShowDateLong($dataRefer[0]->DocDate); ?></span> ซึ่งได้รับการอนุมัติ <span class="textcolor"><?php echo $dataRefer[0]->Title; ?></span> ปีงบประมาณ <span class="textcolor"><?php echo $BgtYear; ?></span> ในวงเงิน <span class="textcolor"><?php echo number_format($dataRefer[0]->TotalCost,2); ?></span> บาท (<span class="textcolor"><?php echo JThaiBaht::_($dataRefer[0]->TotalCost); ?></span>) รายละเอียดตามเอกสารที่แนบท้ายนี้ </td>
  </tr>
  <tr>
    <td colspan="2" height="16"></td>
  </tr>
  <tr>
    <td colspan="2"  style="text-indent:40px; text-align:justify"> บัดนี้ ข้าพเจ้า <span class="textcolor"><?php echo $get->fn_getFullNameByPersonalCode($RQPersonalCode); ?></span> มีความประสงค์จะ <span class="textcolor"><?php echo $Detail; ?></span> ณ <span class="textcolor"><?php echo ($Location)?$Location:'-'; ?></span> ในวันที่ <span class="textcolor"><?php echo ShowDateLong($StartDate);?></span> ถึงวันที่ <span class="textcolor"><?php echo ShowDateLong($EndDate);?></span> รวมเป็นเวลา <span class="textcolor"><?php echo ($AmountDate)?$AmountDate:'-'; ?></span> วัน	
      ซึ่งมีผู้เข้าร่วมปฏิบัติงานจำนวน <span class="textcolor"><?php echo ($AmountPerson)?$AmountPerson:'-'; ?></span> คน  โดยมีค่าใช้จ่ายดังนี้ </td>
  </tr>
  <tr>
    <td colspan="2" height="16"></td>
  </tr>
...
จึงใคร่ขออนุมัติเดินทางไปปฏิบัติงานและยืมเงินทดรอง เป็นจำนวนเงิน <span class="textcolor"><?php echo number_format($TotalBorrow,2);?></span> บาท (<span class="textcolor"><?php echo JThaiBaht::_($TotalBorrow); ?></span>)
