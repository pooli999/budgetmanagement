...
<?php
$_POST["TotalCost"] = str_replace(",","",$_POST["TotalCost"]);
$_POST["TotalBorrow"] = str_replace(",","",$_POST["TotalBorrow"]);
$_POST["TotalBilling"] = $_POST["TotalCost"]-$_POST["TotalBorrow"];
if($_POST["TotalBorrow"] > $_POST["TotalCost"]){
	$txtRed = "Y";
	$BGInValid = "Y";
}
?>
 <tr>
    ...
    <td><div style="width:120px; float:left; text-align:right; <?php if($txtRed == "Y"){ ?> color:#FF0000; <?php } ?>"><?php echo number_format($_POST["TotalBorrow"],2); ?></div>&nbsp;<b>บาท</b></td>
  </tr>   
 <tr>
    <th>ยอดงบขอวางบิลเบิกจ่าย</th>
    <td><div style="width:120px; float:left; text-align:right; <?php if($txtRed == "Y"){ ?> color:#FF0000; <?php } ?>"><?php echo number_format($_POST["TotalBilling"],2); ?></div>&nbsp;<b>บาท</b></td>
  </tr>   
