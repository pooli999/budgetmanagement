...
?>
  ...
  <tr>
    <td colspan="2"  style="text-indent:40px; text-align:justify" >จึงใคร่ขออนุมัติเดินทางไปปฏิบัติงานและยืมเงินทดรอง เป็นจำนวนเงิน <span class="textcolor"><?php echo number_format($TotalBorrow,2);?></span> บาท (<span class="textcolor"><?php echo JThaiBaht::_($TotalBorrow); ?></span>)
