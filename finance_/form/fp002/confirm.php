...
<?php } ?>  
  ...
  <tr>
	<th>กำหนดเวลาที่ต้องการจ้าง</th>
  	<td>
<b>เป็นเวลา </b><?php echo $_POST["AmountMonth"]; ?><b> เดือน</b><?php echo $_POST["AmountDate"]; ?><b> วัน</b>
<b> ตั้งแต่วันที่ </b><?php echo dateFormat($_POST["StartDate1"]);?><b> ถึงวันที่ </b><?php echo dateFormat($_POST["EndDate1"]);?>    
    </td>
  </tr> 
	...
	<?php 
	if($_POST["Other"]){
		$textOther = str_replace( "<p>", "", $_POST["Other"]);
		$textOther = str_replace( "</p>", "", $textOther);
	   echo $textOther; 
	}else{
