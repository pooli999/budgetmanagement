...
function ValidateForm(f){
		...
		if(getValueTextEditor('Purpose') == ""){
			jAlert('กรุณากรองช่องวัตถุประสงค์หรือความจำเป็นในการจัดจ้าง',function(){
				JQ('#Purpose').focus();
			});
			return false;
		}
		if(getValueTextEditor('Description') == ""){
			jAlert('กรุณากรองช่องรายละเอียดเกี่ยวกับการจ้าง',function(){
				JQ('#Description').focus();
			});
			return false;
		}
		if(JQ('#AmountMonth').val() == ""){
			jAlert('กรุณากรอกช่องกำหนดเวลาที่ต้องการจ้าง',function(){
				JQ('#AmountMonth').focus();
			});
			return false;
		}
...
function Confirm(f){
	if(ValidateForm(f)){
		...
		getValueTextEditor('Purpose');		
		getValueTextEditor('Description');		
		getValueTextEditor('Other');		
...
<?php 
 ...
 ?>
  ...
  <tr>
    ...
    <tr>
    <th colspan="3">วัตถุประสงค์หรือความจำเป็นในการจัดจ้าง <span class="require">*</span></th>
  </tr>  
  <tr>
    <td  colspan="3">
	<?php
	...
	?>	
      ...
      <tr>
    <th colspan="3">รายละเอียดเกี่ยวกับการจ้าง <span class="require">*</span></th>
  </tr>  
  <tr>
    <td  colspan="3">
	<?php
    ...
    <td class="require">&nbsp;</td>
  	<td>	
    <b>เป็นเวลา <span class="require">*</span></b> 
    <input type="text" name="AmountMonth" id="AmountMonth" value="<?php echo $AmountMonth; ?>" style="width:50px; text-align:center;" /> <b>เดือน</b>
    <input type="text" name="AmountDate" id="AmountDate" value="<?php echo $AmountDate; ?>" style="width:50px; text-align:center;" /> <b>วัน</b>
	<b> ตั้งแต่วันที่ </b>
	<?php 
        ...
        <b> ถึงวันที่ </b>    
        <?php 
		if($EndDate1=="") $EndDate1 = date('Y-m-d');
	  	echo InputCalendar_text(array(
			'id' => 'EndDate1',
			'name' => 'EndDate1',
			'value' => $EndDate1
        ...
        <tr>
    <th colspan="3">รายละเอียดอื่นที่จำเป็นตามควรแก่กรณี</th>
  </tr>  
  <tr>
    <td  colspan="3">
	<?php
...
<!--END รายการค่าใช้จ่าย-->
    ...
    <tr>
    <th colspan="3">คณะกรรมการจัดหาพัสดุ</th>
  </tr>  
<tr style="vertical-align:top;">
...
<thead>
    <tr>
      ...
      <td style="text-align:center; width:250px;">ตำแหน่ง</td>
      <td style="text-align:center; width:250px;">หน้าที่</td>
    </tr>
</thead>
    <tr>
    	<td style="text-align:center;">1</td>
    	<td style="text-align:left;"><?php echo ePerson(array('name'=>'CommiteeName1','id'=>'CommiteeName1','value'=>$CommiteeName1));?></td>
    	<td style="text-align:center;"><?php echo $get->getPositionList($CommiteePosition1,"CommiteePosition1");?></td>
        <td style="text-align:center;"><?php echo $get->getDuty($CommiteeDuty1,'CommiteeDuty1','style="width:95%"','เลือก');?></td>
  	</tr>
     <tr>
    	<td style="text-align:center;">2</td>
    	<td style="text-align:left;"><?php echo ePerson(array('name'=>'CommiteeName2','id'=>'CommiteeName2','value'=>$CommiteeName2));?></td>
    	<td style="text-align:center;"><?php echo $get->getPositionList($CommiteePosition2,"CommiteePosition2");?></td>
        <td style="text-align:center;"><?php echo $get->getDuty($CommiteeDuty2,'CommiteeDuty2','style="width:95%"','เลือก');?></td>
  	</tr>
    <tr>
    	<td style="text-align:center;">3</td>
    	<td style="text-align:left;"><?php echo ePerson(array('name'=>'CommiteeName3','id'=>'CommiteeName3','value'=>$CommiteeName3));?></td>
    	<td style="text-align:center;"><?php echo $get->getPositionList($CommiteePosition3,"CommiteePosition3");?></td>
        <td style="text-align:center;"><?php echo $get->getDuty($CommiteeDuty3,'CommiteeDuty3','style="width:95%"','เลือก');?></td>
  	</tr>
</table>
