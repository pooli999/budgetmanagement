...
<table width="100%" border="0" cellspacing="1" cellpadding="1" class="tbl-view">
  ...
  <tr>
    ...
    <td><?php echo (ShowDate($StartDate))?ShowDate($StartDate):'<span style="color:#999;">-ไม่ระบุ-</span>'; ?>&nbsp;<b>ถึง</b>&nbsp;<?php echo (ShowDate($EndDate))?ShowDate($EndDate):'<span style="color:#999;">-ไม่ระบุ-</span>'; ?>&nbsp;<b>รวมเป็นเวลา</b>&nbsp;<?php echo ($AmountDate)?$AmountDate:'<span style="color:#999;">-ไม่ระบุ-</span>'; ?>&nbsp;<b>วัน</b></td>
  </tr>
  <tr>
