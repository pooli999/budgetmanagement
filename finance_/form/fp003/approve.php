...
<table width="100%" border="0" cellspacing="1" cellpadding="1" class="tbl-view">
  ...
  <tr>
    <th>วันที่ใช้งาน</th>
    <td><?php echo dateFormat($StartDate);?></td>
  </tr>
  <tr>
    <th>บริษัท/ห้าง/ร้าน</th>
    <td>(<?php echo $PartnerCode;?>) <?php echo $PartnerName;?></td>
  </tr>
  <tr>
    <th>&nbsp;</th>
    <td style="font-weight:bold; color:#666;"> ใบเสร็จรับเงิน/ใบกำกับภาษี/ใบส่งของ/ใบแจ้งหนี้/เล่มที่ <span style="font-weight:normal;"><?php echo $BillNo;?></span> เลขที่ <span style="font-weight:normal;"><?php echo $BillNumber;?></span> ลงวันที่ <span style="font-weight:normal;"><?php echo dateFormat($BillDate);?></span></td>
  </tr>
