...
?>
 ...
 ?>
  ...
  <tr>
    <th valign="top">มีความจำเป็นเร่งด่วนที่จะต้องดำเนินการ</th>
    <td valign="top"><?php 
  ...
  <tr>
    <th valign="top">เพื่อใช้ในงาน</th>
    <td valign="top"><?php 
   	$textPurpose = str_replace( "<p>", "", $_POST["Purpose"]);
	$textPurpose = str_replace( "</p>", "", $textPurpose);
   echo $textPurpose; 
   ?></td>
  </tr>
  <tr>
    <th valign="top">ระบุเหตุผลความจำเป็นเร่งด่วนเพิ่มเติม</th>
    <td valign="top"><?php 
   	$textDescription = str_replace( "<p>", "", $_POST["Description"]);
	$textDescription = str_replace( "</p>", "", $textDescription);
   echo $textDescription; 
   ?></td>
  </tr>
  <tr>
    <th>วันที่ใช้งาน</th>
    <td><?php echo dateFormat($_POST["StartDate"]);?></td>
  </tr>
  <tr>
    <th>บริษัท/ห้าง/ร้าน</th>
    <td>(<?php echo $_POST["PartnerCode"];?>) <?php echo $_POST["PartnerName"];?></td>
  </tr>
  <tr>
    <th>&nbsp;</th>
    <td style="font-weight:bold; color:#666;"> ใบเสร็จรับเงิน/ใบกำกับภาษี/ใบส่งของ/ใบแจ้งหนี้/เล่มที่ <span style="font-weight:normal;"><?php echo $_POST["BillNo"];?></span> เลขที่ <span style="font-weight:normal;"><?php echo $_POST["BillNumber"];?></span> ลงวันที่ <span style="font-weight:normal;"><?php echo dateFormat($_POST["BillDate"]);?></span></td>
  </tr>
...
<!--END รายการค่าใช้จ่าย-->
    ...
    <tr>
    <th colspan="2">คณะกรรมการตรวจรับพัสดุ</th>
  </tr>  
<tr style="vertical-align:top;">
...
<thead>
    ...
    <tr>
    	...
    	<td style="text-align:left;"><?php echo $get->fn_getFullNameByPersonalCode($_POST["CommiteeName1"]);?></td>
    	<td style="text-align:left;"><?php echo $get->getPositionName($_POST["CommiteePosition1"]);?></td>
        <td style="text-align:left;"><?php echo $get->getDutyName($_POST["CommiteeDuty1"]); ?></td>
  	</tr>
     <tr>
    	<td style="text-align:center;">2</td>
    	<td style="text-align:left;"><?php echo $get->fn_getFullNameByPersonalCode($_POST["CommiteeName2"]);?></td>
    	<td style="text-align:left;"><?php echo $get->getPositionName($_POST["CommiteePosition2"]);?></td>
        <td style="text-align:left;"><?php echo $get->getDutyName($_POST["CommiteeDuty2"]); ?></td>
  	</tr>
    <tr>
    	<td style="text-align:center;">3</td>
    	<td style="text-align:left;"><?php echo $get->fn_getFullNameByPersonalCode($_POST["CommiteeName3"]);?></td>
    	<td style="text-align:left;"><?php echo $get->getPositionName($_POST["CommiteePosition3"]);?></td>
        <td style="text-align:left;"><?php echo $get->getDutyName($_POST["CommiteeDuty3"]); ?></td>
  	</tr>
</table>
