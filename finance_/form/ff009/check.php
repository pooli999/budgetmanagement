...
เงินโอน<br />
<div style="float:left"><b>จำนวน</b> <input type="text" name="ReturnCost" id="ReturnCost" value="<?php echo $ReturnCost; ?>" style="width:100px; text-align:center;" onkeypress="return validChars(event,2)"  /> <b>บาท</b> </div><div id = "hide_p"><input type="checkbox" name="checkbox2" value="checkbox"  />เงินสดย่อย</div></td>
    </tr>  
