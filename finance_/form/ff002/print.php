...
<table width="100%" border="0" cellspacing="0" cellpadding="3" align="center">
  ...
  <tr>
    <td colspan="2" style="border-bottom:1px solid #999; padding-bottom:10px;"><div style="width:50px; float:left;">เรื่อง</div><span class="textcolor"><?php echo $Topic; ?></span> ที่ประเทศ <span class="textcolor"><?php echo $get->getMasterCountryName($CountryCode);?></span></td>
 </tr>
   <tr>
...
ความเป็นมา (เรื่องเดิม) <span class="textcolor"><?php echo $Detail; ?></span> ซึ่งมีผู้เข้าร่วมประชุม/ผู้ร่วมเดินทางในครั้งนี้ จำนวน <span class="textcolor"><?php echo ($AmountPerson)?$AmountPerson:'-'; ?></span> ท่าน (รายละเอียดดังเอกสารแนบท้าย)    
</td>
  </tr>
   <tr>
    <td colspan="2" height="16"></td>
    ...
    <tr>
    <td colspan="2"  style="text-indent:40px; text-align:justify">
ทั้งนี้ คณะผู้เข้าร่วมประชุม/ผู้เข้าร่วมเดินทาง (ไป) ออกเดินทางจากประเทศไทยตั้งแต่วันที่ <span class="textcolor"><?php echo dateFormat($StartDate1);?></span> ถึงประเทศ <span class="textcolor"><?php echo $get->getMasterCountryName($CountryCode);?></span> วันที่ <span class="textcolor"><?php echo dateFormat($EndDate1);?></span> และ (กลับ)ออกจากประเทศ วันที่ <span class="textcolor"><?php echo dateFormat($StartDate2);?> </span>ถึงประเทศไทยวันที่  <span class="textcolor"><?php echo dateFormat($EndDate2);?> </span> 
</td>
  </tr>
   <tr>
    <td colspan="2" height="16"></td>
  ...
  <tr>
    <td colspan="2"  style="text-indent:40px; text-align:justify" >
ค่าใช้จ่ายในการเดินทางครั้งนี้ เบิกจ่ายจากงบประมาณ    
 ...
 กิจกรรม&nbsp;<span class="textcolor"><?php echo $get->getPrjActName($PrjActCode); ?></span> (<span class="textcolor"><?php echo $PrjActCode; ?></span>)  รวมเป็นเงินทั้งสิ้น <span class="textcolor"><?php echo number_format($TotalCost,2);?></span> บาท (<span class="textcolor"><?php echo JThaiBaht::_($TotalCost);?></span>) รายละเอียดดังนี้
	</td>
  </tr>
...
<?php } ?>        
  ...
  <tr>
    <td colspan="2"  style="text-indent:40px; text-align:justify" >
จึงเรียนมาเพื่อโปรดพิจารณาอนุมัติหลักการดังกล่าว จะเป็นพระคุณ
	</td>
  </tr>
</table>
