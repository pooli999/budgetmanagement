...
<table width="100%" border="0" cellspacing="0" cellpadding="3" align="center">
  ...
  <tr>
   ...
   <tr>
    <td colspan="2" style="border-bottom:1px solid #999; padding-bottom:10px;">เรื่อง&nbsp;<span class="textcolor"><?php echo $Topic; ?></span> ที่ประเทศ <span class="textcolor"><?php echo $get->getMasterCountryName($CountryCode);?></span></td>
 </tr>
   <tr>
