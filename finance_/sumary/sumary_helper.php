...
class sHelper
{
	...
	*/	
	...
	function getSumBGPlan($PItemCode=0,$PrjDetailId=0,$PrjActId=0){
		$where = array();
		$PItemCode = ($_REQUEST["PItemCode"])?$_REQUEST["PItemCode"]:$PItemCode;
		$PrjDetailId = ($_REQUEST["PrjDetailId"])?$_REQUEST["PrjDetailId"]:$PrjDetailId;
		$PrjActId = ($_REQUEST["PrjActId"])?$_REQUEST["PrjActId"]:$PrjActId;
		if($PItemCode){
	...
	/* START*/
	/* Function Name: getSumBGHoldWait */
	/* Description: เป็นฟังก์ชันสำหรับดึงยอดงบประมาณหลักการคงเหลือ */
	function getSumBGHoldWait($PItemCode=0,$PrjDetailId=0,$PrjActId=0){
		$where = array();
		$where[] = "t8.ApproveStatus='N' ";
		$PItemCode = ($_REQUEST["PItemCode"])?$_REQUEST["PItemCode"]:$PItemCode;
		$PrjDetailId = ($_REQUEST["PrjDetailId"])?$_REQUEST["PrjDetailId"]:$PrjDetailId;
		$PrjActId = ($_REQUEST["PrjActId"])?$_REQUEST["PrjActId"]:$PrjActId;
		if($PItemCode){
	...
	/* Description: เป็นฟังก์ชันสำหรับดึงยอดงบประมาณหลักการคงเหลือ */
	function getSumBGHold($PItemCode=0,$PrjDetailId=0,$PrjActId=0){
		$where = array();
		$where[] = "t8.ApproveStatus='Y' ";
		$PItemCode = ($_REQUEST["PItemCode"])?$_REQUEST["PItemCode"]:$PItemCode;
		$PrjDetailId = ($_REQUEST["PrjDetailId"])?$_REQUEST["PrjDetailId"]:$PrjDetailId;
		$PrjActId = ($_REQUEST["PrjActId"])?$_REQUEST["PrjActId"]:$PrjActId;
		if($PItemCode){
	...
	function getSumBGChain($PItemCode=0,$PrjDetailId=0,$PrjActId=0){
		$where = array();
		$PItemCode = ($_REQUEST["PItemCode"])?$_REQUEST["PItemCode"]:$PItemCode;
		$PrjDetailId = ($_REQUEST["PrjDetailId"])?$_REQUEST["PrjDetailId"]:$PrjDetailId;
		$PrjActId = ($_REQUEST["PrjActId"])?$_REQUEST["PrjActId"]:$PrjActId;
	...
	/* START*/
	/* Function Name: getSumBGPayWait */
	/* Description: เป็นฟังก์ชันสำหรับดึงยอดงบประมาณเบิกจ่าย */
	function getSumBGPayWait($PItemCode=0,$PrjDetailId=0,$PrjActId=0){
		$where = array();
		$where[] = "t8.ApproveStatus='N' ";
		$PItemCode = ($_REQUEST["PItemCode"])?$_REQUEST["PItemCode"]:$PItemCode;
		$PrjDetailId = ($_REQUEST["PrjDetailId"])?$_REQUEST["PrjDetailId"]:$PrjDetailId;
	...
	/* Description: เป็นฟังก์ชันสำหรับดึงยอดงบประมาณเบิกจ่าย */
	function getSumBGPay($PItemCode=0,$PrjDetailId=0,$PrjActId=0){
		$where = array();
		$where[] = "t8.ApproveStatus='Y' ";
		$PItemCode = ($_REQUEST["PItemCode"])?$_REQUEST["PItemCode"]:$PItemCode;
		$PrjDetailId = ($_REQUEST["PrjDetailId"])?$_REQUEST["PrjDetailId"]:$PrjDetailId;
	...
	function getSumBGTferIn($PItemCode=0,$PrjDetailId=0,$PrjActId=0){
		$where = array();
		$where[] = "t8.ApproveStatus='Y'";
		$PItemCode = ($_REQUEST["PItemCode"])?$_REQUEST["PItemCode"]:$PItemCode;
		$PrjDetailId = ($_REQUEST["PrjDetailId"])?$_REQUEST["PrjDetailId"]:$PrjDetailId;
	...
	function getSumBGTferOut($PItemCode=0,$PrjDetailId=0,$PrjActId=0){
		$where = array();
		$where[] = "t8.ApproveStatus='Y'";
		$PItemCode = ($_REQUEST["PItemCode"])?$_REQUEST["PItemCode"]:$PItemCode;
		$PrjDetailId = ($_REQUEST["PrjDetailId"])?$_REQUEST["PrjDetailId"]:$PrjDetailId;
	...
	/* START*/
	/* Function Name: getWaitSumBGTferOut */
	/* Description: เป็นฟังก์ชันสำหรับดึงยอดงบประมาณโอนออก */
	function getWaitSumBGTferOut($PItemCode=0,$PrjDetailId=0,$PrjActId=0){
		$where = array();
		$where[] = "t8.ApproveStatus='N' ";
		$PItemCode = ($_REQUEST["PItemCode"])?$_REQUEST["PItemCode"]:$PItemCode;
		$PrjDetailId = ($_REQUEST["PrjDetailId"])?$_REQUEST["PrjDetailId"]:$PrjDetailId;
	...
	function getSumBGBorrow($PItemCode=0,$PrjDetailId=0,$PrjActId=0){
		$where = array();
		$PItemCode = ($_REQUEST["PItemCode"])?$_REQUEST["PItemCode"]:$PItemCode;
		$PrjDetailId = ($_REQUEST["PrjDetailId"])?$_REQUEST["PrjDetailId"]:$PrjDetailId;
		$PrjActId = ($_REQUEST["PrjActId"])?$_REQUEST["PrjActId"]:$PrjActId;
