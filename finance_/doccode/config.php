...
switch($KeyPage)
{
	case "doccode":
			...
			$startupPage = "startup";
			$actionPage = "doccode_action";
			$mainPage = "doccode_main";
			$listPage = "doccode_list";
			$addPage = "doccode_add";
			$confirmPage = "doccode_confirm";
			$viewPage = "doccode_view";
			$printPage = "doccode_print";
			$wordPage = "doccode_word";
