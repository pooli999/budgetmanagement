  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1">
    <tr>
      <td>
        ...
        เลขที่ สช.น:  </b> <input name="tsearch" id="tsearch" type="text" class="input-search" size="30" value="<?php echo $_REQUEST['tsearch']?>" />
...
<thead>
  <tr>
    ...
    <th width="150" align="center" style="width:150px;">เลขที่ สช.น </th>
    <th align="center" >รายละเอียด
      <input name="data1" type="hidden" id="data1" value="" /></th>
    <th width="200" align="center" style="width:200px;">จำนวนเงินสดย่อย<br /> 
      (บาท)</th>
...
?>
  ...
  <tr>
    ...
    <td align="center" valign="top" ><?php echo number_format($cash,2);?></td>
