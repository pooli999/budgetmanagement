...
<input type="button" class="btn" name="button4" id="button4" value="กลับไปแก้ไข" onclick="goPage('?mod=<?php echo lurl::dotPage("plan_ind");?>&LPlanCode=<?php echo $_REQUEST['LPlanCode'];?>&LindId=<?php echo $_REQUEST['LindId'];?>');"  />
