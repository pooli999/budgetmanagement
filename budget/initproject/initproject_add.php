...
<table width="100%" border="0" cellspacing="1" cellpadding="1" class="tbl-view">
  ...
  <tr>
    ...
    <td id="pitembox"><?php 
	if ($PrjCode != ""){
		echo "แผนงานธรรมนูญสุขภาพ";
	}else{
		echo $get->getPlanItemList(($BgtYear)?$BgtYear:$_REQUEST["BgtYear"],$PItemCode,'onchange="loadPrj()" style="width:80%"','PItemCode');
	}
	?></td>
  </tr>
  <?php if($_GET["id"] != ""){ ?> 
...
<div id="main-project"><?php echo $get->getMainProjectList($LPlanCode,$LPrjCode);?></div></td>
</tr>
<!--<tr>
  <th> 	ตัวชี้วัดภายใต้แผนงาน สช. : ## </th>
  <td class="require">&nbsp;</td>
  <td id="orgbox"><select name="select">
  		<option value="">ระบุ</option>
	  	<option value="0">(V02M0157-K01) ได้ชุดข้อเสนอที่ชัดเจนเพื่อทบทวนธรรมนูญว่าด้วยระบบสุขภาพแห่งชาติ</option>
        <option value="1">(V02M0157-K02) เกิดการขับเคลื่อนนโยบายสาธารณะจากสาระที่เป็นประเด็นสำคัญของธรรมนูญว่าด้วยระบบสุขภาพแห่งชาติ จำนวน ๒ เรื่อง</option>
        <option value="2">(V02M0157-K03) มีกระบวนการจัดทำธรรมนูญว่าด้วยระบบสุขภาพเฉพาะพื้นที่ จำนวน ๒๕๐ พื้นที่ </option>
        <option value="3">(V02M0157-K04) มีข้อเสนอนโยบายสาธารณะเพื่อสุขภาพที่เสนอต่อคณะรัฐมนตรีจำนวน ๘ เรื่อง</option>
		<option value="4"> ได้รายงานสถานการณ์ระบบสุขภาพ</option>
      </select></td>
</tr>-->
<tr>
...
<tr>
  ...
  <input name="PrjMethods" id="PrjMethods2" type="radio" value="quarterly" <?php if($PrjMethods == "quarterly"){ echo 'checked="checked"'; } ?> /> รายไตรมาส  </td>
</tr>
<tr>
  <th>ลักษณะโครงการ</th>
  <td class="require">*</td>
