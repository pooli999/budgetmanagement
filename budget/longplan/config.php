...
{
	case "plan":
			$PathUpload = VSROOT.'upload/plan/';
			$startupPage = "startup";
			$actionPage = "longplan_action";
			$listPage = "longplan_list";
			$addPage = "longplan_add";
			//$confirmPage = "longplan_confirm";
			$sortPage = "longplan_sort";
			$viewPage = "longplan_view";
