...
<?php if($PGroupId == 12){ ?>
<?php  if($PGroupName != "ยุทธศาสตร์ชาติ" || $PGroupName != "แผนงาน " || $PGroupName != "เป้าหมายเชิงยุทธศาสตร์"){?>
<tr>
<th>อ้างอิงแผนหลัก 5 ปี </th>
<td colspan="2">
<?php // echo ($LPlanCode)?($get->getLPlanName($LPlanCode)):('<span style="color:#999;">-ไม่ระบุ-</span>'); ?>แผนงานปีงบประมาณ 2555-2559
<input type="hidden" name="LPlanCode" value="<?php echo $LPlanCode; ?>" /></td>
</tr>
<?php } ?>
...
<?php } ?>
<tr>
  <th>อ้างอิงแผนงานภายใต้แผนหลัก 5 ปี##</th>
  <td class="require">&nbsp;</td>
  <td> แผนงานธรรมนูญสุขภาพ </td>
</tr>
<tr>
      <th>อ้างอิงตัวชี้วัดแผนงานภายใต้แผนหลัก 5 ปี##</th>
      <td class="require">*</td>
      <td><?php echo $get->getIndList($LindCode);?></td>
    </tr>   
<tr>
    <th>รหัสตัวชี้วัด</th>
    <td class="require">&nbsp;</td>
...
<textarea style="width:99%; height:50px;" name="PIndName" id="PIndName"><?php echo $PIndName; ?></textarea>	</td>
</tr>
<tr style="vertical-align:top;">
...
<tr style="vertical-align:top;">
  ...
  <td>
    ...
    <?php echo ePerson(array('name'=>'PersonalSelect[]','id'=>'PersonalSelect','value'=>implodeString($get->getTaskPerson($PIndCode),'PersonalCode'),'selecttype'=>'multi'));?>    </td>
</tr>
<tr>
  <th>หน่วยนับ</th>
  <td class="require">*</td>
