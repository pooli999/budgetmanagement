...
JQ(document).ready(function() {
	JQ("#btn_copy").live('click',function(){  
		var r = confirm("ต้องการคัดลอกแผนงานหลักประจำปี 2558 ใช่หรือไม่");
		if (r == true) {
			alert( "คัดลอกแผนงานหลักประจำปี 2558 แล้ว");
		}
	});
	JQ( ".button4d-copy" ).button({
		icons: {
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbl-button">
  <tr>
    ...
    <a href="javascript:saveToExcel();" class="icon-excel">ส่งออกเป็น Excel</a>&nbsp;
	 <a id = "btn_copy" href="#" class="icon-copy">&nbsp;คัดลอกแผนงานหลักประจำปี</a>
    </td>
  </tr>
</table>
...
<table width="100%" border="1" class="tbl-list" cellspacing="0" cellpadding="0">
  <thead>
  <tr>
    <th width="26" align="center" style="width:15px;">&nbsp;</th>
    <th width="944" align="center">นโยบายแผนงานประจำปี</th>
...
?>
  <tr style="background-color:#dfc7df;">
    ...
    <td colspan="3">
	<? if ($i == "12"){?>
		คัดลอกแผนงานจากแผนงานภายใต้แผนหลักโดยอัตโนมัติ
	<? }else{?>
		<?php echo icoAddSub($r);?>
	<? }?>
	</td>
    </tr>
...
?>
              <tr style="background-color:#c9e39c;" valign="top"><!-- onmouseover="this.bgColor='#fffbcc'" onmouseout="this.bgColor='#FFFFFF'" #ded4d7-->
                ...
                <td width="238" valign="top" nowrap="nowrap" style="width:85px;"  ><?php echo icoAddInd($grp);?></td>
                <td width="134" valign="top" nowrap="nowrap" style="width:60px;"  ><?php echo icoEdit($grp);?></td>
                <td width="134" valign="top"  nowrap="nowrap" style="width:60px;" ><?php echo icoDelete($grp);?></td>
              </tr>  
