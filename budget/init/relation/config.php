...
{
	case "relation":
			$PathUpload = VSROOT.'upload/relation/';
			$startupPage = "startup";
			$actionPage = "relation_action";
			$listPage = "relation_list";
			$addPage = "relation_add";
			//$confirmPage = "relation_confirm";
			$viewPage = "relation_view";
