...
<input type="button" class="btn" name="Cancel" id="Cancel" value="กลับไปแก้ไข" onclick="goPage('?mod=<?php echo lurl::dotPage("project_ind_add");?>&BgtYear=<?php echo $_REQUEST["BgtYear"];?>&OrganizeCode=<?php echo $_REQUEST["OrganizeCode"];?>&SCTypeId=<?php echo $_REQUEST["SCTypeId"];?>&ScreenLevel=<?php echo $_REQUEST["ScreenLevel"];?>&PrjId=<?php echo $_REQUEST["PrjId"];?>&PrjDetailId=<?php echo $_REQUEST["PrjDetailId"];?>&PrjIndId=<?php echo $_REQUEST["PrjIndId"];?>');"  />
