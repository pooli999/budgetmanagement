...
?>          </td>
          ...
          <td style="text-align:center; width:120px;"><a class="ico edit" id = "edit_name">WorkSpace</a></td>
	...
	?>
        <tr>
          <td colspan="9" style="text-align:center; height:30px; background-color:#FFF;" ><span style="color:#999;">-ไม่ระบุ-</span></td>
        </tr>
        <?php	
		}
    ?>
...
<div id="dialog-edit_name"  title="Workspace ที่เกี่ยวข้อง">
