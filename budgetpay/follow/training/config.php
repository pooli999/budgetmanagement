...
{
	case "training":
			$PathUpload = VSROOT.'upload/training/';
			$startupPage = "startup";
			$actionPage = "training_action";
			$mainPage = "training_main";
			$listPage = "training_list";
			$addPage = "training_add";
			$confirmPage = "training_confirm";
			$viewPage = "training_view";
			...
			$appPage = "training_approve";
			$appconfirmPage = "training_appconfirm";
	break;
