...
{
	case "mat":
			$PathUpload = VSROOT.'upload/mat/';
			$startupPage = "startup";
			$actionPage = "mat_action";
			$mainPage = "mat_main";
			$listPage = "mat_list";
			$addPage = "mat_add";
			$confirmPage = "mat_confirm";
			$viewPage = "mat_view";
			$printPage = "mat_print";
			$printPage2 = "mat_print2";
			$printPage3 = "mat_print3";
			$wordPage = "mat_word";
			$wordPage2 = "mat_word2";
			$wordPage3 = "mat_word3";
...
$GLOBALS["printPage2"] = $printPage2;
$GLOBALS["printPage3"] = $printPage3;
$GLOBALS["wordPage"] = $wordPage;
$GLOBALS["wordPage2"] = $wordPage2;
$GLOBALS["wordPage3"] = $wordPage3;
