...
{
	case "matpay":
			$PathUpload = VSROOT.'upload/matpay/';
			$startupPage = "startup";
			$actionPage = "matpay_action";
			$mainPage = "matpay_main";
			$listPage = "matpay_list";
			$addPage = "matpay_add";
			$confirmPage = "matpay_confirm";
			$confirmpayPage = "matpay_confirmpay";
			$viewPage = "matpay_view";
			$printPage = "matpay_print";
			$wordPage = "matpay_word";
			...
			$appPage = "matpay_approve";
			$appconfirmPage = "matpay_appconfirm";	
			
			$cancelPage = "matpay_cancel";
			$cancelconfirmPage = "matpay_cancelconfirm";		
	break;
...
$GLOBALS["addPayPage"] = $addPayPage;
$GLOBALS["confirmPage"] = $confirmPage;
$GLOBALS["confirmpayPage"] = $confirmpayPage;
$GLOBALS["viewPage"] = $viewPage;
$GLOBALS["printPage"] = $printPage;
