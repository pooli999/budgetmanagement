...
if($action = ltxt::getVar( 'action','req' )) {
	...
	switch( strtolower($action) ) {
		...
		case 'doccoderefer':
			...
			$DocCodeNow = ltxt::getVar( 'DocCodeNow','post' );
			echo $tsk->getTrainingDetail($DocCode,$DocCodeNow);			
			exit;
		break;	

		case 'selectformname':
		 	$FormId = ltxt::getVar( 'FormId','post' );
			$datarefer =  $tsk->getSelectFormName($FormId);		
