...
{
	case "urgent":
			$PathUpload = VSROOT.'upload/urgent/';
			$startupPage = "startup";
			$actionPage = "urgent_action";
			$mainPage = "urgent_main";
			$listPage = "urgent_list";
			$addPage = "urgent_add";
			$confirmPage = "urgent_confirm";
			$viewPage = "urgent_view";
			$printPage = "urgent_print";
			$wordPage = "urgent_word";
			...
			$cancelPage = "urgent_cancel";
			$cancelconfirmPage = "urgent_cancelconfirm";
	break;
