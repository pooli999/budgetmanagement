...
<div class="sysinfo">
  ...
  <div class="sysdetail">สำหรับยกเลิกการตัดจ่ายงบประมาณ</div>
</div>
...
<input type="hidden" name="DocCodePay" id="DocCodePay" value="<?php echo $DocCode; ?>" />
<input type="hidden" name="DocCode" id="DocCode" value="<?php echo $detail->DocCode; ?>" />
...
<input type="hidden" name="FormCode" id="FormCode" value="<?php echo $_REQUEST["FormCode"];?>" />
