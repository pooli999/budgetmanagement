...
switch($KeyPage)
{
	case "gpay":
			...
			$startupPage = "startup";
			$actionPage = "gpay_action";
			$mainPage = "gpay_main";
			$listPage = "gpay_list";
			$addPage = "gpay_add";
			$confirmPage = "gpay_confirm";
			$confirmpayPage = "gpay_confirmpay";
			$viewPage = "gpay_view";
			$printPage = "gpay_print";
			$wordPage = "gpay_word";
			...
			$appPage = "gpay_approve";
			$appconfirmPage = "gpay_appconfirm";	
			
			$cancelPage = "gpay_cancel";
			$cancelconfirmPage = "gpay_cancelconfirm";		
	break;
