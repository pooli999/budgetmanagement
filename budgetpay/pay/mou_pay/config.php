...
{
	case "moupay":
			$PathUpload = VSROOT.'upload/mou/';
			$startupPage = "startup";
			$actionPage = "moupay_action";
			$mainPage = "moupay_main";
			$listPage = "moupay_list";
			$addPage = "moupay_add";
			$confirmPage = "moupay_confirm";
			$confirmpayPage = "moupay_confirmpay";
			$viewPage = "moupay_view";
			$printPage = "moupay_print";
			$wordPage = "moupay_word";
			...
			$appPage = "moupay_approve";
			$appconfirmPage = "moupay_appconfirm";	
			
			$cancelPage = "moupay_cancel";
			$cancelconfirmPage = "moupay_cancelconfirm";		
	break;
