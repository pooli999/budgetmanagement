...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center"  bgcolor="#FFFFFF"  bordercolor="#FFFFFF">
  <tr>
    <td align="right" valign="top" ><span class="textid">แบบ FP002<br>(วงเงินการจัดหาเกิน 300,000)</span></td>
  </tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="3" align="center">
 ...
 <tr>
    <td colspan="2"  style="text-indent:55px; text-align:justify" >6.&nbsp;&nbsp;แต่งตั้งคณะกรรมการจัดหาพัสดุ</td>
 </tr>   
  <tr>
    <td colspan="2"  style="text-indent:74px; text-align:justify" >ตามประกาศสำนักงานคณะกรรมการสุขภาพแห่งชาติ เรื่องหลักเกณฑ์ แนวทาง และวิธีปฏิบัติเกี่ยวกับพัสดุ พ.ศ. 2554 ในข้อ 6-8 หากเป็นการจัดหาพัสดุครั้งหนึ่งซึ่งมีวงเงินเกิน 300,000 บาท (สามแสนบาทถ้วน) จะต้องแต่งตั้งคณะกรรมการจัดหาพัสดุจำนวน 3 คน ซึ่ง<span class="textcolor"><?php echo $get->getOrganizeName($OrganizeCode); ?></span> เสนอขอแต่งตั้ง
...
<table border="0" cellspacing="0" cellpadding="0"  width="100%">
	...
	<?php 
		$actList = $get->getMatStaff($DocCode);		//ltxt::print_r($actList);
		 if($actList){
			 $i = 1;
	...
	?>  
  <tr>
  <td width="50%" align="left" valign="top" style="text-indent:74px;"><span class="textcolor"><?php echo $i;?>)&nbsp;&nbsp;<?php echo fn_getFullNameByPersonalCode($StaffPersonalCode);?></span></td>
