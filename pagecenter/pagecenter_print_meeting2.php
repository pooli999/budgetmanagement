...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center"  bgcolor="#FFFFFF"  bordercolor="#FFFFFF">
  <tr>
    <td align="right" valign="top" ><span class="textid">แบบ FF006</span></td>
  </tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">  
  ...
  <tr>
    <td colspan="2" >
    	เรื่อง&nbsp;&nbsp;&nbsp;<span class="textcolor">ขออนุมัติเดินทางไปปฏิบัติงาน ณ <?php echo $Topic; ?></span>&nbsp;
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="2"  style="text-indent:44px; text-align:justify" >เนื่องด้วย ข้าพเจ้า<span class="textcolor"><?php echo fn_getFullNameByPersonalCode($PersonalCode);?></span> มีความประสงค์จะ<span class="textcolor"><?php $textDetail = str_replace( "<p>", "", $Detail); $textDetail = str_replace( "</p>", "", $textDetail); echo $textDetail; ?></span> ณ <span class="textcolor"><?php echo $Location; ?></span> ในวันที่ <span class="textcolor"><?php echo ShowDateLong($StartDate);?></span> ถึงวันที่  <span class="textcolor"><?php echo ShowDateLong($EndDate);?></span> รวมเป็นเวลา <span class="textcolor"><span id="countdate"><?php  echo $get->getdays($StartDate,$EndDate); ?></span></span> วัน	ซึ่งมีผู้เข้าร่วมปฏิบัติงานจำนวน <span class="textcolor"><?php echo $AmountPerson;?></span> คน โดยมีรายการค่าใช้จ่ายดังนี้</td>
  </tr>
  <tr>
    <td colspan="2"  height="16"></td>
  </tr>  
  <tr>
    <td colspan="2"   valign="top">
        ...
        <?php 		
        $groupList = $get->getCostGroupGeneral('tblintra_eform_formal_meeting_cost','DocCode','CostId',$DocCode);
        ...
        if($groupList){
         ...
         ?>
                  ...
                  <tr>
                   ...
                   <?php  		
                        $costList = $get->getCostItemListGeneral('tblintra_eform_formal_meeting_cost','DocCode','CostId',$DocCode,$rg->CostItemCode);
        ...
        <?php $i++; } ?>
                  ...
                  <tr >
                      	<td style="text-align:right;" colspan="2">(<span class="textcolor"><?php echo JThaiBaht::_($get->getSumCostMeeting($DocCode,$PrjActCode,0,0)); ?></span>)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;รวมทุกหมวดงบประมาณ </td>
                      	<td style="text-align:right;padding-left:10px; "><span class="textcolor"><?php echo number_format($get->getSumCostMeeting($DocCode,$PrjActCode,0,0),2); ?></span> บาท</td>
                  </tr>
        <?php 
        }else{ 
  ...
  <tr>
    <td colspan="2"  style="text-indent:44px; text-align:justify" >จึงใคร่ขออนุมัติเดินทางไปปฏิบัติงาน โดยใช้<span class="textcolor"><?php 
