...
<!--  <tr>
  ...
  <tr>
    <td colspan="2"  style="text-indent:37px; text-align:justify" >ด้วย<span class="textcolor"><?php echo $get->getOrganizeName($OrganizeCode); ?></span> มีความประสงค์จะ<span class="textcolor"><?php $textDetail = str_replace( "<p>", "", $Detail); $textDetail = str_replace( "</p>", "", $textDetail); echo $textDetail; ?></span> มีรายการค่าใช้จ่ายดังนี้</td>
  </tr>
  ...
  <tr>
    ...
    <tr>
    <td colspan="2" style="text-indent:37px; text-align:justify" >โดยสั่งจ่ายเช็คในนาม <span class="textcolor"><?php echo $PaidCheckBy;?></span></td>
  </tr>
  <tr>
    <td colspan="2" height="16"></td>
  </tr>  
  <tr>
    <td colspan="2"  style="text-indent:37px; text-align:justify" >จึงใคร่ขออนุมัติเบิกจ่ายค่าใช้จ่ายดังกล่าว โดยใช้
