...
/*                foreach($rRName as $k=>$v){
  ...
  <tr>
    <td  colspan="2" style="text-align:left; padding-left:40px;"><span class="textcolor"><?php echo $Detail; ?></span></td>
  </tr>
  <tr>
    <td colspan="2"  style="text-align:justify; " >โดยเบิกจ่ายภายในวงเงินงบประมาณ <span class="textcolor"><?php echo number_format($TotalCostPay+$TotalOTOther,2); ?></span> บาท  (<span class="textcolor"><?php echo JThaiBaht::_($TotalCostPay+$TotalOTOther); ?></span>)
