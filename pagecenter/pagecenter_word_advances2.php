...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center"  bgcolor="#FFFFFF"  bordercolor="#FFFFFF">
  <tr>
    <td align="right" valign="top" style="font-size:14pt;">แบบ FF002</td>
  </tr>
</table>
...
<!--          <tr style="line-height:160%">
  ...
  <tr>
    <td colspan="2"  style="text-indent:40px; text-align:justify" >จึงใครเดินทางไปปฏิบัติงานและยืมเงินทดรองเป็นจำนวนเงิน <span class="textcolor"><?php echo number_format($get->getSumCostBorrow($DocCode,$PrjActCode,0,0),2); ?></span> บาท (<span class="textcolor"><?php echo JThaiBaht::_($get->getSumCostBorrow($DocCode,$PrjActCode,0,0)); ?></span>)
