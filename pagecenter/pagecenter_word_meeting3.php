...
<!--        <tr>
        ...
        <?php $i++; } ?>
                  ...
                  <tr >
                      	<td style="text-align:right;" colspan="2">(<span class="textcolor"><?php echo JThaiBaht::_($get->getSumCostMeetingPay($DocCodePay,$PrjActCode,0,0)); ?></span>)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;รวมทุกหมวดงบประมาณ </td>
                      	<td style="text-align:right;padding-left:10px; "><span class="textcolor"><?php echo number_format($get->getSumCostMeetingPay($DocCodePay,$PrjActCode,0,0),2); ?></span> บาท</td>
                  </tr>
        <?php 
        }else{ 
  ...
  <tr>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0"   align="center">
		...
		?>
        		  <tr><td colspan="3" height="5"></td></tr>	
                  <tr >
                      	<td style="text-align:right;" colspan="2">(<span class="textcolor"><?php echo JThaiBaht::_($get->getSumCostOther($DocCodePay,$PrjActCode,0,0,$DocCode,$TaskNo)); ?></span>)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;รวมทุกหมวดงบประมาณ </td>
                      	<td style="text-align:right;padding-left:10px; "><span class="textcolor"><?php echo number_format($get->getSumCostOther($DocCodePay,$PrjActCode,0,0,$DocCode,$TaskNo),2); ?></span> บาท</td>
                  </tr>
        <?php 
        }else{ 
        echo '<tr><td align="center" height="300" style="color:#f00;">- - ไม่มีรายการชี้แจง - -</td></tr>';
  ...
  <tr>
    <td colspan="2"  style="text-indent:37px; text-align:justify" >จึงใคร่ขออนุมัติเบิกจ่ายค่าใช้จ่ายดังกล่าว โดยใช้<span class="textcolor"><?php 
