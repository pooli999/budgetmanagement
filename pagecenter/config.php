...
{
	case "pagecenter":
			$PathUpload = VSROOT.'upload/pagecenter/';
			$startupPage = "startup";
			$actionPage = "pagecenter_action";
			$generalPrintPage = "pagecenter_print_general";
			$generalWordPage = "pagecenter_word_general";
...
$GLOBALS["generalPrintPage"] = $generalPrintPage;
$GLOBALS["generalWordPage"] = $generalWordPage;
