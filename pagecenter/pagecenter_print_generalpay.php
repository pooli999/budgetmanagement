...
//ltxt::print_r($detail);	
$DataG = $get->getDetailGeneral('tblintra_eform_formal_general','DocCode',$DocCode);	//ltxt::print_r($DataG);	
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center"  bgcolor="#FFFFFF"  bordercolor="#FFFFFF">
  <tr>
    <td align="right" valign="top" ><span class="textid">แบบ FF009</span></td>
  </tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="3" align="center">
  ...
  <tr>
    <td colspan="2"  style="text-indent:44px; text-align:justify" >ในการนี้ <span class="textcolor"><?php echo $get->getOrganizeName($DataG->OrganizeCode); ?></span> จึงใคร่ขออนุมัติเบิกจ่ายเงินสนับสนุนโครงการดังกล่าว  ในปีงบประมาณ พ.ศ. <span class="textcolor"><?php echo $DataG->BgtYear; ?></span> เป็นเงิน <span class="textcolor"><?php echo number_format($get->getSumCostGeneral('tblintra_eform_formal_general_pay_cost','DocCodePay',$DocCodePay,0,0,0),2); ?></span> บาท (<span class="textcolor"><?php echo JThaiBaht::_($get->getSumCostGeneral('tblintra_eform_formal_general_pay_cost','DocCodePay',$DocCodePay,0,0,0)); ?></span>)
   โดยเบิกจาก<span class="textcolor"><?php 
    ...
    ภายใต้<span class="textcolor"><?php echo $get->getPItemName($DataG->PItemCode);?>   
    <?php echo $get->getPrjName($DataG->PrjId);?>  
    </span>
    กิจกรรม<span class="textcolor"><?php echo $get->getPrjActName($DataG->PrjActCode);?>  (<?php echo $DataG->PrjActCode;?>) </span>
	</td>
  </tr>
  <tr>
    <td colspan="2"  height="16"></td>
  ...
  <tr>
    <td colspan="2"  style="text-indent:44px; text-align:justify" >จึงเรียนมาเพื่อโปรดพิจารณาอนุมัติเบิกจ่ายด้วย จะเป็นพระคุณ</td>
  </tr>
</table>
