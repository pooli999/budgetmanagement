...
$TotalBGPrj = $get->getTotalPrj(0,$OrganizeCode,$PItemCode,$PrjId);	
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center"  bgcolor="#FFFFFF"  bordercolor="#FFFFFF">
  <tr>
    <td align="right" valign="top" ><span class="textid">แบบ FP004<br />(วงเงินการจัดหาไม่เกิน 5,000 บาท)</span></td>
  </tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="3" align="center">
  ...
  <tr>
   ...
   <tr>
    <td colspan="2" style="padding-left:44px;"><strong>1.&nbsp;&nbsp;<u>ความเป็นมา</u></strong>
	</td>
  </tr>
  <tr>
    <td colspan="2"  style="text-indent:60px; text-align:justify" >ด้วย <span class="textcolor"><?php echo $get->getOrganizeName($OrganizeCode); ?></span> มีความจำเป็นที่จะ<span class="textcolor"><?php echo $Detail; ?></span> ภายใต้<span class="textcolor"><?php echo $get->getPItemName($PItemCode);?> <?php echo $get->getPrjName($PrjId);?></span> กิจกรรม<span class="textcolor"><?php echo $get->getPrjActName($PrjActCode);?> (<?php echo $PrjActCode;?>)</span> ซึ่งมีวงเงินงบประมาณไม่เกิน 5,000 บาท
    </td>
  </tr>
  <tr>
    <td colspan="2"  style="text-indent:60px; text-align:justify" ><span class="textcolor"><?php echo $get->getOrganizeName($OrganizeCode); ?></span> จึงได้<span class="textcolor"><?php echo $UrgentType; ?><?php echo $Description; ?></span> จาก<span class="textcolor"><?php echo $ComName; ?></span> ตาม<span class="textcolor"><?php echo $Bill; ?></span> ลงวันที่ <span class="textcolor"><?php echo ShowDateLong($DocDate);?></span> เป็นเงิน <span class="textcolor"><?php echo number_format($get->getSumCostGeneral('tblintra_eform_mat_urgent_cost','DocCode',$DocCode,$PrjActCode,0,0),2); ?></span> บาท 
(<span class="textcolor"><?php echo JThaiBaht::_($get->getSumCostGeneral('tblintra_eform_mat_urgent_cost','DocCode',$DocCode,$PrjActCode,0,0)); ?></span>)  ดังรายละเอียดในสิ่งที่ส่งมาด้วยพร้อมนี้  
  ...
  <tr>
    <td colspan="2" style="padding-left:44px;"><strong>3.&nbsp;&nbsp;<u>ข้อเสนอ</u></strong>
	</td>
  </tr>
   <tr>
  ...
  <tr>
    <td colspan="2"  style="text-indent:60px; text-align:justify" >3.1&nbsp;&nbsp;อนุมัติให้<span class="textcolor"><?php echo $UrgentType; ?><?php echo $Description; ?></span> จาก<span class="textcolor"><?php echo $ComName; ?></span> ดังรายละเอียดในข้อ 1 โดยวิธีการตกลงราคา กรณีวงเงินไม่เกิน 5,000 บาท</td>
  </tr>     
  <tr>
    <td colspan="2"  style="text-indent:60px; text-align:justify" >3.2&nbsp;&nbsp;อนุมัติให้เบิกจ่ายงบจำนวนทั้งสิ้น <span class="textcolor"><?php echo number_format($get->getSumCostGeneral('tblintra_eform_mat_urgent_cost','DocCode',$DocCode,$PrjActCode,0,0),2); ?></span> บาท 
